 ...
 */
	...
	if(isset($result) && hasRows($result)){
		...
		while($row = mysql_fetch_row($result)){
			...
			echo ($row[2] != '' && $row[4] != '' && $row[5] != '') ? '<a href="'.$hc_cfg[52].'maps?q='.$row[8].','.$row[9].'" target="_blank"><img src="'.CalRoot.'/img/icons/map.png" width="16" height="16" alt="' . $hc_lang_search['Map'] . '" /></a>' : '';
