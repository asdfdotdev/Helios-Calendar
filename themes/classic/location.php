...
<div id="container">
	<div id="content" itemscope itemtype="http://schema.org/Place">
		<div id="menu"><?php cal_menu();?></div>
		
		<h1 itemprop="name"><?php echo $myLoc['Name'];?>
			<?php get_comments_link($myLoc['CommentsID'],$myLoc['CommentsURL'],1)?></h1>

		<div id="evernote" itemprop="description"><?php echo $myLoc['Description'];?></div>
		
		<div id="detail_left">
			<div>
				<h2><?php echo location_lang('Address');?></h2>				
	...
	<?php	}?>
		...
		<div id="detail_right">
			...
			<?php
				...
				<h5><?php echo location_lang('Share');?></h5>
				...
				<h5><?php echo location_lang('LocationTools');?></h5>

				<a href="<?php echo $myLoc['Link_Weather'];?>" class="icon weather" target="_blank"><?php echo location_lang('Weather');?></a><br />
				<a href="<?php echo $myLoc['Link_Directions'];?>" target="_blank" itemprop="geo" itemscope="itemscope" itemtype="http://schema.org/GeoCoordinates" class="icon directions">
		...
		<h2><?php echo location_lang('UpcomingEvents');?>
			<a href="<?php echo cal_url();?>/rss/l.php?lID=<?php echo $myLoc['LocID'];?>" class="icon rss loc_rss" target="_blank" rel="nofollow"></a></h2>
