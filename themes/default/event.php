...
<?php	if($myEvnt['VenueID'] > 0){?>
		var latlng = new google.maps.LatLng(<?php echo $myEvnt['Venue_Lat'];?>, <?php echo $myEvnt['Venue_Lon'];?>);
		...
		google.maps.event.addListener(marker, 'click', function() {
			window.open('<?php echo html_entity_decode($myLnks['Venue_Directions']);?>','_blank');
		});
<?php	}?>
	}
	//-->
...
<?php
	$crumbs = array('/' => 'Home', cal_url() => 'Calendar',$myLnks['This'] => $myEvnt['Title']);
	...
	<section>
		...
		<?php	}?>
				...
				<span itemprop="description"><?php echo $myEvnt['Description'];?></span>
			</div>
			<div id="detail_left">
	...
	<aside>
		...
		<?php mini_cal_month($myEvnt['DateRaw']);?>
