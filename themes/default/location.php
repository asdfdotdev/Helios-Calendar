 ...
 */
	...
	function initialize() {
		var latlng = new google.maps.LatLng(<?php echo $myLoc['Lat'];?>, <?php echo $myLoc['Lon'];?>);
		
		var myOptions = {
			zoom: <?php gmap_zoom(1);?>,
			center: latlng,
		...
		var infowindow = new google.maps.InfoWindow({
		    content: '<?php gmap_info('<b>'.$myLoc['Name'].'</b><br />'.buildAddress($myLoc['Address'],$myLoc['Address2'],$myLoc['City'],$myLoc['Region'],$myLoc['Postal'],$myLoc['Country'],0).'<br /><br /><a href="'.$myLoc['Link_Directions'].'">'.location_lang('Directions').'</a>');?>'
		});
		...
		<article itemscope itemtype="http://schema.org/Organization">
			<header>
				<div class="social">
					...
					<div class="socialF">
						<div class="fb-like" data-href="<?php echo urlencode($myLnks['This']);?>" data-send="false" data-layout="button_count" data-width="75" data-show-faces="false"></div>
					</div>
					<div class="socialL">
			...
			<div id="evernote" itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
				<div id="location">
				...
				<span itemprop="description"><?php echo $myLoc['Description'];?></span>
			</div>
			<div id="detail_left">
		<?php			
