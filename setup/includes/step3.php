...
<?php	} else {
			...
			mysql_query("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('8', 'http://maps.google.com/maps?f=d&q=[address],%20[city],%20[region]%20[postalcode]%20[country]', 'link_map')");
