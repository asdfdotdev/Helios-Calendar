...
<?php	} else {
			...
			function DoInstall($status, $msg, $query, $params = array()){
				echo '<div style="padding-left:5px;line-height:15px;">' . $msg;

				$result = doQuery($query, $params);
				$errno  = hc_mysql_errno();

				if(!$errno){
					echo '<b>Finished</b>';
				} else {
					++$status;
					echo '<span style="color:#DC1461;font-weight:bold;">Failed: ErrNo:'.$errno.'</span>';
				}
			...
			$status = DoInstall($status,"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Adding First Admin Account...",
								"INSERT INTO " . HC_TblPrefix . "admin VALUES('1',?,?,?,?,'1','0', NULL, '0', '1', NULL, NULL, NOW())", array(
									$_POST['firstname'],
									$_POST['lastname'],
									$_POST['email'],
									md5(md5($_POST['password']) . $_POST['email'])
								));
			...
			doQuery("INSERT INTO `" . HC_TblPrefix . "mailgroups` (`PkID`, `Name`, `Description`, `IsPublic`, `IsActive`) VALUES (1, 'All Subscribers', '', 0, 1)");
			doQuery("INSERT INTO `" . HC_TblPrefix . "mailgroups` (`PkID`, `Name`, `Description`, `IsPublic`, `IsActive`) VALUES (2, 'Test Subscribers', 'Internal email addresses for various mail services. Used for test mailings.', 0, 1)");
			...
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('1', '1', 'submit_on')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('2', '20', 'rss_max_size')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('3', 'Your event has been approved and is now available on our public calendar. We hope you continue to use our calendar and submit more events in the future. Thank you for using our calendar and if you have any questions please feel free to contact us.', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('4', 'Your event has been declined and will not be available on our website. Please do not let this discourage you from submiting more events in the future. Thank you for using our calendar and if you have any questions please feel free to contact us.', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('5', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('6', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('7', '1', 'meta_index')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('8', 'http://www.google.com/maps/search/[address]+[city]+[region]+[postalcode]+[country]', 'link_map')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('9', 'http://www.weather.com/weather/local/[postalcode]', 'link_weather')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('10', '10', 'list_popular_size')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('11', '1', 'browse_past_on')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('12', '10', 'list_billboard_size')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('13', '0', 'list_billboard_autofill')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('14', '%A, %d %B, %Y', 'date_format_long')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('15', '1', 'list_billboard_show_time')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('16', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('17', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('18', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('19', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('20', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('21', NULL, 'region_default')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('22', '0', 'minical_start_day')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('23', '%I:%M %p', 'time_format')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('24', '%m/%d/%Y', 'date_format_short')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('25', NULL, 'comments_disqus_shortname')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('26', '90', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('27', '13', 'map_single_zoom')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('28', 'english', 'language_default')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('29', '1', 'submit_allow_categories')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('30', '1', 'editor_on')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('31', '12', 'time_1224')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('32', '0', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('33', '1', 'list_rss_combine_series')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('34', '0', 'browse_default_size')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('35', '0', 'timezone_offset')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('36', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('37', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('38', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('39', 'Submitted by Helios Calendar', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('40', '75', 'submit_session_limit')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('41', '8', 'map_multi_zoom')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('42', NULL, 'map_multi_center_lat')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('43', NULL, 'map_multi_center_lon')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('44', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('45', '0', 'map_multi_on')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('46', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('47', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('48', '0', 'browse_float_on')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('49', '".$curVersion."', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('50', '0', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('51', 'MM/dd/yyyy', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('52', 'http://maps.google.com/', 'map_google_url')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('53', '14', 'search_default_window')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('54', '1', 'newsletter_on')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('55', '1', 'map_library')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('56', '0', 'comments_on')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('57', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('58', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('59', '#helioscal', 'tweet_hashtag')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('60', '50', 'syndication_list_cache_max')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('61', '3.31', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('62', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('63', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('64', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('65', '0', 'captcha_on')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('66', '10', 'list_newest_size')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('67', NULL, 'captcha_recaptcha_public')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('68', NULL, 'captcha_recaptcha_private')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('69', '0', 'syndication_map_on')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('70', '1', 'location_select_type')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('71', '0', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('72', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('73', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('74', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('75', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('76', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('77', '0', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('78', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('79', NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('80', '5', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('81', '25', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('82', '2', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (83, 'default', 'theme_default_desktop')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (84, 'mobile', 'theme_default_mobile')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (85, '/(bot|crawler|indexing|checker|sleuth|seeker)/', 'filter_bots')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (86, '/android|astel|avantgo|audiovox|blackberry|blazer|cldc|compal|droid|docomo|ddipocket|elaine|epoc|fennec|hiptop|ibisbrowser|iemobile|ip(hone|od)|j-phone|j2me|htc|kindle|maemo|midp|minimo|mmp|mobile|netfront|nokia|o2|opera m(ob|in)i|opwv|palm|phonifier|plink|plucker|pocket|polaris|playstation|regking|scope|smartphone|symbian(os)|tear|teleca|treo|up.(browser|link)|vodafone|wap|wii|windows (ce|phone)|wireless|xiino/', 'filter_mobile')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (87, '500', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (88, '99', 'ical_size_max')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (89, '360', 'ical_refresh')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (90, 'clean', 'captcha_recaptcha_style')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (91, '1', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (92, '%b %Y', 'date_format_minical_select')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (93, '%d', 'date_format_minical_day')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (94, '1', 'map_olayers_provider')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (95, NULL, 'map_yahoo_api_key')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (96, NULL, 'map_bing_api_key')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (97, '1', 'page_digest_on')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (98, '<p>This welcome message can be edited within the admin console.</p>', 'page_digest_welcome')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (99, '7', 'page_digest_new_days')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (100, '5', 'comments_facebook_posts')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (101, '685', 'comments_facebook_width')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (102, NULL, 'comments_livefyre_id')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (103, NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (104, NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (105, NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (106, '1', 'rss_on')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (107, '200', 'rss_description_trim')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (108, '1', 'ical_on')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (109, '200', 'ical_description_trim')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (110, NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (111, NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (112, NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (113, '0', 'signin_twitter_on')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (114, '0', 'signin_facebook_on')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (115, '0', 'signin_google_on')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (116, '0', '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (117, NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (118, NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (119, NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (120, NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (121, NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (122, NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (123, NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (124, NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (125, NULL, '')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (126, '0', 'send_past_to_friend')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (127, '1', 'api_on_off')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (128, '1', 'api_cache_type')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (129, '25', 'api_list_size_events')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (130, '10', 'api_cache_user_limit')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (131, '10', 'api_cache_user_log_time')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (132, '10', 'api_list_size_newsletters')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (133, '1.0', 'api_version')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES (134, '14', 'meta_expire_days')");
			echo '<b>Finished</b></div>';
			...
			echo '<div style="padding-left:5px;line-height:15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Configuring Default Settings...';
			doQuery("INSERT INTO `" . HC_TblPrefix . "settingsmeta` (`PkID`, `Keywords`,`Description`,`Title`,`Sort`) VALUES ('1',NULL,NULL,NULL,'2')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settingsmeta` (`PkID`, `Keywords`,`Description`,`Title`,`Sort`) VALUES ('2',NULL,NULL,NULL,'3')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settingsmeta` (`PkID`, `Keywords`,`Description`,`Title`,`Sort`) VALUES ('3',NULL,NULL,NULL,'4')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settingsmeta` (`PkID`, `Keywords`,`Description`,`Title`,`Sort`) VALUES ('4',NULL,NULL,NULL,'5')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settingsmeta` (`PkID`, `Keywords`,`Description`,`Title`,`Sort`) VALUES ('5',NULL,NULL,NULL,'6')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settingsmeta` (`PkID`, `Keywords`,`Description`,`Title`,`Sort`) VALUES ('6',NULL,NULL,NULL,'8')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settingsmeta` (`PkID`, `Keywords`,`Description`,`Title`,`Sort`) VALUES ('7',NULL,NULL,NULL,'10')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settingsmeta` (`PkID`, `Keywords`,`Description`,`Title`,`Sort`) VALUES ('8',NULL,NULL,NULL,'11')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settingsmeta` (`PkID`, `Keywords`,`Description`,`Title`,`Sort`) VALUES ('9',NULL,NULL,NULL,'12')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settingsmeta` (`PkID`, `Keywords`,`Description`,`Title`,`Sort`) VALUES ('10',NULL,NULL,NULL,'13')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settingsmeta` (`PkID`, `Keywords`,`Description`,`Title`,`Sort`) VALUES ('11',NULL,NULL,NULL,'7')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settingsmeta` (`PkID`, `Keywords`,`Description`,`Title`,`Sort`) VALUES ('12',NULL,NULL,NULL,'9')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settingsmeta` (`PkID`, `Keywords`,`Description`,`Title`,`Sort`) VALUES ('13',NULL,NULL,NULL,'14')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settingsmeta` (`PkID`, `Keywords`,`Description`,`Title`,`Sort`) VALUES ('14',NULL,NULL,NULL,'1')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settingsmeta` (`PkID`, `Keywords`,`Description`,`Title`,`Sort`) VALUES ('15',NULL,NULL,NULL,'15')");
			doQuery("INSERT INTO `" . HC_TblPrefix . "settingsmeta` (`PkID`, `Keywords`,`Description`,`Title`,`Sort`) VALUES ('16',NULL,NULL,NULL,'16')");
