...
<?php	} else {
			...
			mysql_query("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('8', 'http://www.google.com/maps/search/[address]+[city]+[region]+[postalcode]+[country]', 'link_map')");
			...
			mysql_query("INSERT INTO `" . HC_TblPrefix . "settings` (`PkID`,`SettingValue`,`Name`) VALUES ('61', '3.31', '')");
