...
/*	To Skin Helios to your sites layout edit anything in the <body> tag of this page
	...
	It is recommended you store images for your skin in the template directory with the stylesheet.
	
	Use the following include statements
	
	include(HC_Login) -----	OpenID Login Links
