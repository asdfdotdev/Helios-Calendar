...
<table columns="1">
	<?php
		$result = doQuery("SELECT * FROM " . HC_TblPrefix . "events WHERE StartDate = '" . $theDate . "' ORDER BY StartDate, TBD, StartTime, Title");
	?>
	<tr>
	...
	<?php
		...
		<tr>
				...
				?>
			<td><a href="<?echo CalRoot;?>/wml/details.php?eID=<?echo $row[0];?>"><?echo cleanWMLChars($timeStamp) . "--" . cleanWMLChars($row[1]);?></a><br/><br/></td>
		</tr>
		<?
		}//end while
	?>
