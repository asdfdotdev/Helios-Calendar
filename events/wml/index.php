...
<card id="no1" title="<?php echo CalName;?> Mobile Site">
<p>
<table columns="3">
	<tr>
		<td><a href="<?php echo CalRoot;?>/wml/?date=<?php echo $nextDate;?>">Next</a>&nbsp;&nbsp;&nbsp;</td>
		<td><a href="<?php echo CalRoot;?>/wml/?date=<?php echo date("Y") . "-" . date("m") . "-" . date("d");?>">Today</a>&nbsp;&nbsp;&nbsp;</td>
	</tr>
</table>
<table columns="1">
	<?php
	...
	?>
	<tr>
		<td><b><?php echo cleanWMLChars( $dateStamp );?></b></td>
	</tr>
	<?php
		...
		<tr>
				...
				?>
			<td><a href="<?php echo CalRoot;?>/wml/details.php?eID=<?php echo $row[0];?>"><?php echo cleanWMLChars(strip_tags($timeStamp)) . "--" . cleanWMLChars(strip_tags($row[1]));?></a><br/><br/></td>
		</tr>
<?php 	}//end while
	?>
</table>
...
<?php
	...
	Powered by Helios <?php echo HC_Version;?>
</p>
</card>
