...
*/
	if(!isset($_SESSION['license']) || $_SESSION['license'] == false || !isset($_SESSION['good']) || $_SESSION['good'] == false || !isset($_SESSION['valid']) || $_SESSION['valid'] == false || !isset($_SESSION['done']) || $_SESSION['done'] == false){
		...
		echo '<br /><br />We invite you to join the conversation and share your Helios Calendar story at <a href="http://www.refreshmy.com/forum/" class="main" target="_blank">the Refresh Community Forums</a>.';
