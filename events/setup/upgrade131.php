...
<head>
	...
	<title>Helios Calendar Legacy Upgrade</title>
	<style type="text/css">
		html, body {margin: 0;padding: 0px 0 10px 0;background: #EFEFEF;color: #000000;font-family: Verdana, sans-serif;font-size: 11px;}
		#container {margin: auto auto auto auto ; width: 760px; padding: 0;border: 1px solid #CCCCCC;background: #FFFFFF;color: #000000;}
		#content {float: left; text-align: left; padding: 5px;width: 513px;}
		#controls {float: left;padding: 5px 5px 20px 5px;width: 225px;}
		#billboard {text-align: left;padding: 10px 0 10px 0;}
		#popular {text-align: left;padding: 10px 0 10px 0;}
		#valid {text-align: center;}
		#copyright {clear: both; color: #666666;background: #FFFFFF;padding: 5px 0px 5px 15px;line-height: 17px;}
		a.copyright {text-decoration: none;color: #666666;background: #FFFFFF;}
		a.copyright:hover {text-decoration: underline;color: #FF6600;background: #FFFFFF;}
		a.copyrightR {text-decoration: none;color: #666666;background: #FFFFFF;}
...
<div id="container">
	...
	<?php	if(!isset($_POST['uID'])){	?>
				Welcome to the Helios Calendar legacy upgrade script. This script will update your legacy Helios Calendar database to version 1.3.1
				so that you can complete your upgrade with the current version of this script. 
				<br /><br />
				To begin please be sure that your Helios <b>MySQL user has ALTER &amp; CREATE permissions</b> for your Helios database.
				<br /><br />
				Select the upgrade you wish to run from the list below and click "Run Upgrade". The neccessary
				sql to update your Helios database will be run.
				<br /><br />
				...
				<br />
				<form name="frm" id="frm" method="post" action="upgrade131.php" onsubmit="return chkFrm();">
					<select name="uID" id="uID">
						<option value="0">Select Upgrade to Run</option>
						<option value="9">1.3&nbsp;&nbsp;-->&nbsp;&nbsp;<?php echo $curVersion;?></option>
						<option value="8">1.2.1&nbsp;&nbsp;-->&nbsp;&nbsp;<?php echo $curVersion;?></option>
						<option value="7">1.2.0 or 1.2.0.1&nbsp;&nbsp;-->&nbsp;&nbsp;<?php echo $curVersion;?></option>
						<option value="6">1.1.5&nbsp;&nbsp;-->&nbsp;&nbsp;<?php echo $curVersion;?></option>
	...
	<?php	} else {
				...
				switch($_POST['uID']){
					...
					case 2:
						...
						echo "Testing";
						doQuery("INSERT INTO " . HC_TblPrefix . "adminloginhistory(Client) VALUES('12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901')");
						...
						echo "Testing";
						doQuery("INSERT INTO " . HC_TblPrefix . "locations(Name) VALUES('helios_upgrade')");
					...
					case 5:
						...
						if(hasRows($result)){
							...
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Adding Timezone Offset Setting";
					...
					case 6:
						if($_POST['uID'] == 6){
							echo "<b>Upgrading from 1.1.5 to " . $curVersion . "</b><br /><br />";
						}//end if
						
						echo "<br /><br />Adding EventNetwork Table...";
						doQuery("CREATE TABLE `" . HC_TblPrefix . "eventnetwork` (
								  `EventID` int(11) unsigned NOT NULL default '0',
								  `NetworkID` varchar(150) default NULL,
								  `NetworkType` int(11) unsigned default NULL,
								  `IsActive` tinyint(3) unsigned NOT NULL default '0',
								  KEY `NetworkType` (`NetworkType`),
								  KEY `NetworkID` (`NetworkID`),
								  KEY `EventID` (`EventID`)
								)");
						echo "Testing";
						doQuery("INSERT INTO " . HC_TblPrefix . "eventnetwork(NetworkID) VALUES('helios_upgrade')");
						$result = doQuery("SELECT * FROM " . HC_TblPrefix . "eventnetwork WHERE NetworkID = 'helios_upgrade'");
						if(hasRows($result)){
							echo "...Table Add Successful";
						} else {
							$status = 2;
						...
						doQuery("DELETE FROM " . HC_TblPrefix . "eventnetwork WHERE NetworkID = 'helios_upgrade'");
												
						
						echo "<br /><br />Adding LocationNetwork Table...";
						doQuery("CREATE TABLE `" . HC_TblPrefix . "locationnetwork` (
						...
						echo "Testing";
						doQuery("INSERT INTO " . HC_TblPrefix . "locationnetwork(NetworkID) VALUES('helios_upgrade')");
						$result = doQuery("SELECT * FROM " . HC_TblPrefix . "locationnetwork WHERE NetworkID = 'helios_upgrade'");
						if(hasRows($result)){
							echo "...Table Add Successful";
						} else {
							$status = 2;
						...
						doQuery("DELETE FROM " . HC_TblPrefix . "locationnetwork WHERE NetworkID = 'helios_upgrade'");
						
						echo "<br /><br />Checking for Eventful API Setting...";
						$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 36");
						if(hasRows($result)){
							$status = 1;
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Setting Found";
						} else {
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Adding Setting";
							doQuery("INSERT INTO "  . HC_TblPrefix . "settings(PkID, SettingValue) VALUES(36, NULL)");
							$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 36");
							if(hasRows($result)){
								echo "...Add Succesful";
							} else {
						...
						echo "<br /><br />Checking for Eventful Username Setting...";
						$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 37");
						if(hasRows($result)){
							$status = 1;
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Setting Found";
						} else {
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Adding Setting";
							doQuery("INSERT INTO "  . HC_TblPrefix . "settings(PkID, SettingValue) VALUES(37, NULL)");
							$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 37");
							if(hasRows($result)){
								echo "...Add Succesful";
							} else {
						...
						echo "<br /><br />Checking for Eventful Password Setting...";
						$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 38");
						if(hasRows($result)){
							$status = 1;
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Setting Found";
						} else {
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Adding Setting";
							doQuery("INSERT INTO "  . HC_TblPrefix . "settings(PkID, SettingValue) VALUES(38, NULL)");
							$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 38");
							if(hasRows($result)){
								echo "...Add Succesful";
							} else {
						...
						echo "<br /><br />Checking for Eventful Signature Setting...";
						$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 39");
						if(hasRows($result)){
							$status = 1;
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Setting Found";
						} else {
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Adding  Setting";
							doQuery("INSERT INTO "  . HC_TblPrefix . "settings(PkID, SettingValue) VALUES(39, 'This event was submitted by Helios Calendar')");
							$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 39");
							if(hasRows($result)){
								echo "...Add Succesful";
							} else {
						...
						echo "<br /><br />Checking for Submission Limit Setting...";
						$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 40");
						if(hasRows($result)){
							$status = 1;
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Setting Found";
						} else {
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Adding Setting";
							doQuery("INSERT INTO "  . HC_TblPrefix . "settings(PkID, SettingValue) VALUES(40, '50')");
							$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 40");
							if(hasRows($result)){
								echo "...Add Succesful";
							} else {
						...
						echo "<br /><br />Checking for Location Browse Map Zoom Setting...";
						$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 41");
						if(hasRows($result)){
							$status = 1;
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Setting Found";
						} else {
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Adding Setting";
							doQuery("INSERT INTO "  . HC_TblPrefix . "settings(PkID, SettingValue) VALUES(41, '8')");
							$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 41");
							if(hasRows($result)){
								echo "...Add Succesful";
							} else {
						...
						echo "<br /><br />Checking for Location Browse Map Latitude Setting...";
						$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 42");
						if(hasRows($result)){
							$status = 1;
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Setting Found";
						} else {
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Adding Setting";
							doQuery("INSERT INTO "  . HC_TblPrefix . "settings(PkID, SettingValue) VALUES(42, NULL)");
							$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 42");
							if(hasRows($result)){
								echo "...Add Succesful";
							} else {
						...
						echo "<br /><br />Checking for Location Browse Map Longitude Setting...";
						$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 43");
						if(hasRows($result)){
							$status = 1;
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Setting Found";
						} else {
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Adding Setting";
							doQuery("INSERT INTO "  . HC_TblPrefix . "settings(PkID, SettingValue) VALUES(43, NULL)");
							$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 43");
							if(hasRows($result)){
								echo "...Add Succesful";
							} else {
						...
						echo "<br /><br />Adding Field to Users Table...";
						doQuery("ALTER TABLE `"  . HC_TblPrefix . "users` ADD `BirthYear` INT(4) DEFAULT '0' NOT NULL;");
						doQuery("ALTER TABLE `"  . HC_TblPrefix . "users` ADD `Gender` TINYINT(3) UNSIGNED DEFAULT '0' NOT NULL;");
						doQuery("ALTER TABLE `"  . HC_TblPrefix . "users` ADD `Referral` INT(11) UNSIGNED DEFAULT '0' NOT NULL;");
						echo "Finished";
						
					case 7:
						if($_POST['uID'] == 7){
							echo "<b>Upgrading from 1.2.0.x to " . $curVersion . "</b><br /><br />";
						}//end if
						
						echo "<br /><br />Checking for Statistics Setting...";
						$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 44");
						if(hasRows($result)){
							$status = 1;
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Setting Found";
						} else {
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Adding Statistics Reporting Setting (Setting to Off, Please Consider Turning it On)";
							doQuery("INSERT INTO "  . HC_TblPrefix . "settings(PkID, SettingValue) VALUES(44, '0')");
							$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 44");
							if(hasRows($result)){
								echo "...Add Succesful";
							} else {
						...
						echo "<br /><br />Checking for Location Map On/Off...";
						$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 45");
						if(hasRows($result)){
							$status = 1;
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Setting Found";
						} else {
							echo "<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Adding Location Map On/Off";
							doQuery("INSERT INTO "  . HC_TblPrefix . "settings(PkID, SettingValue) VALUES(45, '1')");
							$result = doQuery("SELECT * FROM " . HC_TblPrefix . "settings WHERE PkID = 45");
							if(hasRows($result)){
								echo "...Add Succesful";
							} else {
						...
						doQuery("UPDATE " . HC_TblPrefix . "events
									SET StartTime = '00:00:00'
									WHERE StartTime = '24:00:00';");
						doQuery("UPDATE " . HC_TblPrefix . "events
									SET EndTime = '00:00:00'
									WHERE EndTime = '24:00:00';");
					case 8:
						if($_POST['uID'] == 8){
							echo "<b>Upgrading from 1.2.1 to " . $curVersion . "</b><br /><br />";
						}//end if
						
						echo "<br /><br />Performing Database Updates...";
						
						doQuery("ALTER TABLE `" . HC_TblPrefix . "adminpermissions` ADD `Locations` INT(3) UNSIGNED DEFAULT '0' NOT NULL AFTER `Reports`");
						doQuery("UPDATE `" . HC_TblPrefix . "settings` SET SettingValue = 'english' WHERE PkID = 28");
						doQuery("UPDATE `" . HC_TblPrefix . "adminpermissions` SET Locations = 1");
						doQuery("UPDATE `" . HC_TblPrefix . "settings` SET SettingValue = '%A, %d %B, %Y' WHERE PkID = 14");
						doQuery("UPDATE `" . HC_TblPrefix . "settings` SET SettingValue = '%I:%M %p' WHERE PkID = 23");
						doQuery("UPDATE `" . HC_TblPrefix . "settings` SET SettingValue = '%m/%d/%Y' WHERE PkID = 24");
						doQuery("ALTER TABLE `" . HC_TblPrefix . "registrants` ADD `GroupID` VARCHAR(50) NULL");
						doQuery("ALTER TABLE `" . HC_TblPrefix . "locations` ADD `GoogleAcc` INT(11) UNSIGNED DEFAULT '0' NOT NULL AFTER `Lon`");
						doQuery("ALTER TABLE `" . HC_TblPrefix . "locations` CHANGE `Lat` `Lat` VARCHAR(50) NULL");
						doQuery("ALTER TABLE `" . HC_TblPrefix . "locations` CHANGE `Lon` `Lon` VARCHAR(50) NULL");
						doQuery("ALTER TABLE `" . HC_TblPrefix . "events` ADD FULLTEXT `Search` (`Title`, `LocationName`, `Description`)");
						echo "<br /><br />Updates Complete";
						
					case 9:
						if($_POST['uID'] == 9){
							echo "<b>Upgrading from 1.3 to " . $curVersion . "</b><br /><br />";
						}//end if
						
						echo "<br /><br />Performing Database Updates...";
						
						doQuery("ALTER TABLE `" . HC_TblPrefix . "locations` ADD FULLTEXT `LocName` (`Name`)");
						doQuery("INSERT INTO "  . HC_TblPrefix . "settings(PkID, SettingValue) VALUES(46, NULL)");
						doQuery("INSERT INTO "  . HC_TblPrefix . "settings(PkID, SettingValue) VALUES(47, NULL)");
						doQuery("INSERT INTO "  . HC_TblPrefix . "settings(PkID, SettingValue) VALUES(48, NULL)");
	...
	<div id="copyright">
		<a href="http://www.helioscalendar.com" class="copyright">Helios Calendar</a> Copyright 2004-<?php echo date("Y");?> <a href="http://www.refreshmy.com" class="copyrightR">Refresh Web Development</a>
	</div>
</div>
