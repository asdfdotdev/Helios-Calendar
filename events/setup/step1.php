...
*/?>
	...
	<fieldset>
		...
		<label for="agree" style="margin-top:10px;text-align:left;vertical-align:middle;line-height:20px;width:680px;"><input onchange="if(document.frm.agree.checked == true){document.frm.submit.disabled = false;}else{document.frm.submit.disabled = true;}" type="checkbox" name="agree" id="agree" />&nbsp;I have read, understand and agree to the terms of the Helios Calendar Software License Agreement.</label>
	</fieldset>
	<br />
	<input disabled="disabled" type="submit" name="submit" id="submit" value="Accept License Agreement &amp; Begin Setup" class="button" style="width:250px;" />
	</form>