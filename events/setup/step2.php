...
<?php	} else {	?>
	...
	<?php	if(isset($stop)){?>
			<input type="button" name="refresh" id="refresh" onclick="window.location.href='<?php echo CalRoot;?>/setup/index.php?step=2';return false;" value="Refresh" class="button" />
	<?php	} else {	?>
			<input type="button" name="refresh" id="refresh" onclick="window.location.href='<?php echo CalRoot;?>/setup/?step=3';return false;" value="Continue" class="button" />
	<?php	}//end if	?>
		</div>
<?php	}//end if?>