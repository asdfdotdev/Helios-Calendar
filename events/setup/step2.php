...
<?	} else {	?>
		...
		<div style="float:left;width:380px;">
			...
			<div style="float:left;width:200px;"><?echo HC_TblPrefix;?></div>
			<br /><br />
			<div style="float:left;width:120px;padding-left:25px;"><b>DB Host:</b></div>
			<div style="float:left;width:200px;"><?echo DATABASE_HOST;?></div>
			<br /><br />
			<div style="float:left;width:120px;padding-left:25px;"><b>Database:</b></div>
			<div style="float:left;width:200px;"><?echo DATABASE_NAME;?></div>
			<br /><br />
			<div style="float:left;width:120px;padding-left:25px;"><b>DB User:</b></div>
			<div style="float:left;width:200px;"><?echo DATABASE_USER;?></div>
			<br /><br />
			...
			<div style="float:left;width:200px;"><?echo CalRoot;?>/</div>
			<br /><br />
			<div style="float:left;width:120px;padding-left:25px;"><b>Helios Admin:</b></div>
			<div style="float:left;width:200px;"><?echo CalAdminRoot;?>/</div>
			<br /><br />
			<div style="float:left;width:120px;padding-left:25px;"><b>Mobile Root:</b></div>
			<div style="float:left;width:200px;"><?echo MobileRoot;?>/</div>
			<br /><br />
			<div style="float:left;width:120px;padding-left:25px;"><b>Admin Contact:</b></div>
			<div style="float:left;width:200px;"><a href="mailto:<?echo CalAdminEmail;?>" class="eventMain"><?echo CalAdmin;?></a></div>
			<br /><br />
