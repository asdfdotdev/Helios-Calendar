  ...
  <channel>
	...
	<?php
		...
		if(hasRows($result)){
			...
			?>
				<item>
			      <title><?echo stampToDate(cOut($row[9]), $dateFormat) . " - " . strip_tags(htmlspecialchars(cOut($row[1])));?></title>
			      <link><?echo CalRoot . "/index.php?com=detail&amp;eID=" . $row[0];?></link>
			      <description><?echo strip_tags(htmlspecialchars(cOut($row[8])));?></description>
