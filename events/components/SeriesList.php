...
*/
	...
	if(hasRows($result)){
		...
		while($row = mysql_fetch_row($result)){
			if($cnt == 0){echo "<div class=\"eventDetailTitle\">" . cOut($row[1]) . "</div>";}?>
		...
		<?php 	$startTime = "";
			...
			<div class="<?php if($cnt % 2 == 0){echo "eventListTitle";}else{echo "eventListTitleHL";}//end if?>"><a href="<?php echo CalRoot;?>/index.php?com=detail&amp;eID=<?php echo $row[0];?>" class="eventListTitle"><?php echo stampToDate($row[9], $hc_dateFormat);?></a></div>
<?php 	$cnt++;
		}//end while
	} else {	?>
	<br />
