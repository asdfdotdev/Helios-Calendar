...
<?php	}//end if	?>
		...
		<legend><?php echo $hc_lang_login['LoginLabel'];?></legend>
			...
			<div class="frmOpt">
				...
				<a href="javascript:;" onclick="doOpenID('https://www.google.com/accounts/o8/id');"><img src="<?php echo CalRoot;?>/images/share/google.png" width="16" height="16" alt="" style="vertical-align:middle;" /></a> <a href="javascript:;" onclick="doOpenID('https://www.google.com/accounts/o8/id');" class="openid"><?php echo $hc_lang_login['Google'];?></a><br />
				<a href="javascript:;" onclick="doOpenID('http://yahoo.com');"><img src="<?php echo CalRoot;?>/images/cal/yahoo.png" width="16" height="16" alt="" style="vertical-align:middle;" /></a> <a href="javascript:;" onclick="doOpenID('http://yahoo.com');" class="openid"><?php echo $hc_lang_login['Yahoo'];?></a><br />
				<a href="javascript:;" onclick="doOpenID('http://www.myspace.com');"><img src="<?php echo CalRoot;?>/images/share/myspace.png" width="16" height="16" alt="" style="vertical-align:middle;" /></a> <a href="javascript:;" onclick="doOpenID('http://www.myspace.com');" class="openid"><?php echo $hc_lang_login['MySpaceID'];?></a>
				</div>
			</div>
		</fieldset>
		<br />
