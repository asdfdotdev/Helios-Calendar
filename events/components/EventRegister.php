...
<?php 	} else {
			echo '<div style="height:300px;">' . $hc_lang_register['RegOk'] . '<br />';
			echo '<a href="' . CalRoot . '/index.php?com=detail&eID=' . $eID. '" class="eventMain">' . $hc_lang_register['ReturnListing'] . '</a></div>';
 		}//end if
	} else {
