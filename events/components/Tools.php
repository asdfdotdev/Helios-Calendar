...
*/
	...
	<?php
		if($hc_cfg69 == 1){
			echo '<div class="syndMenu"><b>' . $hc_lang_tools['View'] . '</b> ';
			...
			echo '<div style="line-height:15px;"><b>' . $hc_lang_tools['HeaderCode'] . '</b> [ <a href="' . CalRoot . '/js/map.css" class="eventMain" target="_blank">' . $hc_lang_tools['Template'] . '</a> ]</div>';
...
echo '&lt;link rel="stylesheet" type="text/css" href="http://192.168.2.100/helios/events/js/map.css" /&gt;';
echo "\n" . '&lt;script language="JavaScript" type="text/JavaScript" src="http://maps.google.com//maps?file=api&amp;v=2&amp;key=GM_Key"&gt;&lt;/script&gt;';
			...
			echo '<div style="line-height:15px;"><b>' . $hc_lang_tools['MapCode'] . '</b></div>';
			echo '<div class="frmOpt">';
			echo '<textarea style="width:95%;height:55px;" onfocus="this.select();" wrap="off" rows="15" cols="55" readonly="readonly">';
...
echo "\n" . '&lt;script language="JavaScript" type="text/JavaScript" src="' . CalRoot . '/cache/lmap_embed.js"&gt;&lt;/script&gt;';
			...
			echo '<div style="line-height:15px;"><b>' . $hc_lang_tools['FootCode'] . '</b></div>';
			echo '<div class="frmOpt">';
...
echo '&lt;script language="JavaScript" type="text/JavaScript"&gt;' . "\n" . '//<!--' . "\n" . 'buildGmap();' . "\n" . '//-->' . "\n" . '&lt;/script&gt;';
		...
		echo '</ol>';
		echo '<div style="line-height:15px;"><b>' . $hc_lang_tools['Stylesheet'] . '</b> [ <a href="' . CalRoot . '/js/syndication.css" class="eventMain" target="_blank">' . $hc_lang_tools['Template'] . '</a> ]</div>';
		echo '<div class="frmOpt">';
