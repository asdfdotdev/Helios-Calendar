...
*/
	...
	$result = doQuery("SELECT Title, StartDate, ContactName, ContactEmail FROM " . HC_TblPrefix . "events WHERE PkID = " . $eID);
	...
	<form id="register" name="register" method="post" action="<?echo CalRoot;?>/components/RegisterAction.php" onSubmit="return chkregister();">
		...
		<table cellpadding="0" cellspacing="0" border="0">
			<tr>
				...
				<script language="JavaScript">
				<?
					$eParts = explode("@", mysql_result($result,0,3));
					$edParts = explode(".", $eParts[1]);
				?>
					var who = '<?echo mysql_result($result,0,2);?>';
