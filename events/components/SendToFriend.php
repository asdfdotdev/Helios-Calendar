...
<?	
	...
	<?	if(in_array(2, $hc_captchas)){	?>
		...
		<?php	buildCaptcha();	?><br />
			...
			<div class="frmReq">
				<label>&nbsp;</label>
				<input name="proof" id="proof" type="text" maxlength="8" size="9" value="" onblur="alert('Please verify you have entered the authentication text correctly or you will have to re-enter your email information to send it.');" />
	...
	<?	}//end if	?>
			...
			<div class="frmReq">
				...
				<textarea name="hc_fx5" id="hc_fx5" rows="10" cols="45" onkeyup="this.value=this.value.slice(0, 250)"><?	echo "I was visiting the " . CalName . " today and found the " . cOut(mysql_result($result,0,1)) . " event and thought you would like to know about it.";	?></textarea>
			</div>
		</fieldset>
		<br />
