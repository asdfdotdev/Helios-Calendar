	...
	if(hasRows($result)){
		...
		<fieldset>
			...
			<div class="frmReq">
				...
				<textarea name="message" id="message" rows="10" cols="50" onkeyup="this.value=this.value.slice(0, 250)"><?	echo "I was visiting the " . CalName . " today and found a post for the " . cOut(mysql_result($result,0,1)) . " event and thought you'd like to know about it.";	?></textarea>
			</div>
