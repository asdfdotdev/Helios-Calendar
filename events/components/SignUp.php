...
<?php
	...
	echo "<br /><br />";?>
	<form name="frmEventNewsletter" id="frmEventNewsletter" method="post" action="<?php echo HC_SignupAction;?>" onsubmit="return chkFrm();">
<?php
...
<?php 	fakeFormFields();?>
	...
	<?php 	getCategories('frmEventNewsletter', 2);?>
		</div>
	</fieldset>
	<br />
