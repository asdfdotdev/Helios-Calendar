...
*/
	...
	if(hasRows($result)){
		...
		$groupID = "";
		if($partySize > 1){
			$groupID = md5($regName . $eventTitle . date("U"));
		}//end if
		...
		$result = doQuery("SELECT COUNT(" . HC_TblPrefix . "registrants.EventID), " . HC_TblPrefix . "events.SpacesAvailable
		...
		$Rmsg = "<b>" . $eventTitle . "</b><br /> " . $hc_lang_register['Rmsg'];
		$Cmsg = "<b>" . $eventTitle . "</b><br /> " . $hc_lang_register['Cmsg'];
