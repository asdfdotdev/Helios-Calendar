...
*/
	...
	if(isset($_GET['guid'])){
		...
		<?php 	}//end if	?>
			...
			<form name="frmEventReg" id="frmEventReg" method="post" action="<?php echo CalRoot . '/components/EditRegistrationAction.php';?>" onsubmit="return chkFrm();">
		...
		<?php
			...
			<fieldset>
				...
				<div class="frmReq">
					...
					<input name="hc_f1" id="hc_f1" type="text" size="20" maxlength="50" value="<?php echo $fname;?>" />
				</div>
				<div class="frmReq">
					<label for="hc_f2"><?php echo $hc_lang_register['LastName'];?></label>
					<input name="hc_f2" id="hc_f2" type="text" size="25" maxlength="50" value="<?php echo $lname;?>" />
				</div>
				<div class="frmReq">
			...
			<?php	$occupation = $oID;
					include($hc_langPath . $_SESSION[$hc_cfg00 . 'LangSet'] . '/' . $hc_lang_config['OccupationFile']);?>
				</div>
				<div class="frmOpt">
			...
			<?php 	$query = "SELECT c.PkID, c.CategoryName, c.ParentID, c.CategoryName as Sort, uc.UserID as Selected
