...
<?php
	...
	<fieldset>
		...
		<div class="frmReq">
			...
			<input name="firstname" id="firstname" type="text" size="15" maxlength="50" value="<?php echo $fname;?>" />
		</div>
		<div class="frmReq">
			<label for="lastname">Last Name:</label>
			<input name="lastname" id="lastname" type="text" size="15" maxlength="50" value="<?php echo $lname;?>" />
		</div>
		<div class="frmReq">
	...
	<?php	include('includes/selectOccupation.php');?>
		...
		<div class="frmOpt">
			...
			<input name="zip" id="zip" type="text" size="5" maxlength="5" value="<?php echo $zip;?>" />
		</div>
		<div class="frmOpt">
			<label>Categories:</label>
		<?php 	$query = "	SELECT " . HC_TblPrefix . "categories.*, " . HC_TblPrefix . "usercategories.UserID
