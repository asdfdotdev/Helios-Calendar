...
*/
	//include("../includes/include.php");	//Uncomment to use the Control Panel Outside of Helios	?>
<div id="controlPanel">
...
<?	$i++;
	...
	<br />
	<a href="<?echo CalRoot;?>/rss.php?s=1" class="controlPanel"><img class="controlPanel" src="<?echo CalRoot;?>/images/rss/feedIcon.gif" width="16" height="16" alt="<?echo CalName;?> All Events RSS Feeds" /> Newest Events</a>
	<br />
	<a href="<?echo CalRoot;?>/rss.php?s=3" class="controlPanel"><img class="controlPanel" src="<?echo CalRoot;?>/images/rss/feedIcon.gif" width="16" height="16" alt="<?echo CalName;?> All Events RSS Feeds" /> Billboard Events</a>
	<br />
	<a href="<?echo CalRoot;?>/rss.php?s=2" class="controlPanel"><img class="controlPanel" src="<?echo CalRoot;?>/images/rss/feedIcon.gif" width="16" height="16" alt="<?echo CalName;?> All Events RSS Feeds" /> Most Popular Events</a>
	<br />
</div>