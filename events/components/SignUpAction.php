	...
	if(isset($_POST['catID'])){
		...
		if($row_cnt < 1){
			...
			$msg .= "\n\nYour Account Activation Link:\n" . CalRoot . "/a.php?a=" . $GUID . "\n"
					...
					. "\n\nTo complete the registration process please click on the link above. If your email client does not support HTML you can simply copy and paste the entire web address above into your web browser."
					. "\n\nIf you didn't signup, or have changed your mind, simply delete this email and you will hear nothing further from us in regards to our Event Alert Newsletter."
