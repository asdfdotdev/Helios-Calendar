...
*/
	...
	if(hasRows($result)){
		...
		<div class="locDetails">
			<div class="locDetailHeader"><?php echo $hc_lang_locations['LocLabel'];?>&nbsp;
	<?php	if($locZip != ''){?>
				<a href="<?php echo CalRoot;?>/link/index.php?tID=3&amp;oID=0<?php if($locID > 0){echo "&amp;lID=" . $locID;}?>" class="eventDetailLink" target="_blank"><img class="eventDetailLink" src="<?php echo CalRoot;?>/images/icons/iconWeather.png" width="16" height="16" alt="" border="0" /></a>&nbsp;<a href="<?php echo CalRoot;?>/link/index.php?tID=3&amp;oID=0<?php if($locID > 0){echo "&amp;lID=" . $locID;}?>" class="eventDetailLink" target="_blank"><?php echo $hc_lang_locations['Weather'];?></a>&nbsp;
	<?php	}//end if	
			if($locID > 0) {?>
	...
	<?php	if($locName != ''){
			...
			if($locEmail != ''){	?>
				<br /><?php $hc_lang_locations['Email'];?>
	...
	<?php	}//end if
			if($locPhone != ''){
				echo "<br />" . $hc_lang_locations['Phone'] . " " . $locPhone;
			}//end if
			if($locURL != '' && $locURL != 'http://'){	?>
				<br /><?php echo $hc_lang_locations['Website'];?> <a href="<?php echo CalRoot;?>/link/index.php?tID=4&amp;oID=<?php echo $locID;?>" target="_blank" class="eventMain"><?php echo $hc_lang_locations['Visit'];?></a>
	<?php	}//end if
