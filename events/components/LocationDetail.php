...
*/
	...
	if(hasRows($result)){
		...
		echo ($locZip != '') ? '<a href="' . CalRoot . '/link/index.php?tID=3&amp;oID=0&amp;lID=' . $locID . '" class="eventDetailLink" target="_blank"><img class="eventDetailLink" src="' . CalRoot . '/images/icons/iconWeather.png" width="16" height="16" alt="" border="0" /></a>&nbsp;<a href="' . CalRoot . '/link/index.php?tID=3&amp;oID=0&amp;lID=' . $locID . '" class="eventDetailLink" target="_blank">' . $hc_lang_locations['Weather'] . '</a>&nbsp;' : '';
		echo '<a href="' . CalRoot . '/rssL.php?lID=' . $locID . '" target="_blank"><img src="' . CalRoot . '/images/rss/feedIcon.gif" width="16" height="16" alt="" style="vertical-align:middle;" /></a>';	
		echo '</div>';
