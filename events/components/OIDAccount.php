...
*/
	include($hc_langPath . $_SESSION[$hc_cfg00 . 'LangSet'] . '/public/user.php');

	$uID = (isset($_SESSION[$hc_cfg00 . 'hc_OpenIDPkID'])) ? $_SESSION[$hc_cfg00 . 'hc_OpenIDPkID'] : 0;
	...
	if(hasRows($result)){
		...
		echo '<a href="' . $_SESSION[$hc_cfg00 . 'hc_OpenID'] . '" class="eventMain" target="_blank">' . $_SESSION[$hc_cfg00 . 'hc_OpenID'] . '</a>';
		echo '</div>';
