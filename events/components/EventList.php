...
<?	if(hasRows($result)){
		...
		while($row = mysql_fetch_row($result)){
			...
			<div class="<?if($cnt % 2 == 0){echo "eventListTitle";}else{echo "eventListTitleHL";}//end if?>"><a href="<?echo CalRoot;?>/index.php?com=detail<?echo $calSaver;?>&amp;eID=<?echo $row[0] . $calSaver;?>" class="eventListTitle"><?echo cOut($row[1]);?></a></div>
	<?	$cnt++;
		}//end while
	} else {
	?>
