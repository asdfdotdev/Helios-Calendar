	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr>
			<td colspan="3" align="right">
				...
				<a href="<?echo CalRoot;?>/?theDate=<?echo $prevDate?>&month=<?echo $prevMonth;?>&year=<?echo $prevYear;?>" title="Browse Back One Week"><img src="<?echo CalRoot;?>/images/nav/left.gif" alt="" border="0"></a>
				<a href="<?echo CalRoot;?>/?theDate=<?echo $nextDate?>&month=<?echo $nextMonth;?>&year=<?echo $nextYear;?>" title="Browse Forward One Week"><img src="<?echo CalRoot;?>/images/nav/right.gif" alt="" border="0"></a>
			</td>
		</tr><?
	if(hasRows($result)){
		$cnt = 0;
