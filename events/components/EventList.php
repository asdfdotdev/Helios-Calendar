		...
		<tr>
			<td colspan="3" align="right">
				<?php
					...
					$nextYear = $nextPart[0];
				?>
				<a href="<?echo CalRoot;?>/index.php?com=filter"><img src="<?echo CalRoot;?>/images/nav/filter.gif" alt="" border="0"></a>
				<a href="<?echo CalRoot;?>/"><img src="<?echo CalRoot;?>/images/nav/home.gif" alt="" border="0"></a>
				<a href="<?echo CalRoot;?>/?theDate=<?echo $prevDate?>&month=<?echo $prevMonth;?>&year=<?echo $prevYear;?>"><img src="<?echo CalRoot;?>/images/nav/left.gif" alt="" border="0"></a><a href="<?echo CalRoot;?>/?theDate=<?echo $nextDate?>&month=<?echo $nextMonth;?>&year=<?echo $nextYear;?>"><img src="<?echo CalRoot;?>/images/nav/right.gif" alt="" border="0"></a>
			</td>
		</tr><?
	if(hasRows($result)){
		$cnt = 0;
		...
		?>
			<tr>
				...
				<td style="padding:2px;" <?if($cnt % 2 == 1){echo "class=\"eventListHL\"";}else{echo "class=\"eventMain\"";}//end if?>>
					...
					?>
						<a href="<?echo CalRoot;?>/index.php?com=detail&eID=<?echo $row[0] . $calSaver;?>" class="eventMain"><?echo cOut($row[1]);?></a>
