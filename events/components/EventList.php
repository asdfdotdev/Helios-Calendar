...
*/
	...
	<div id="nav-top">
		...
		<a href="<?php echo CalRoot . "/"; if($locSaver != ''){echo "?" . substr($locSaver,1);}?>" title="Return to This Weeks Events"><img src="<?php echo CalRoot;?>/images/nav/home.gif" alt="" border="0" /></a>
