...
*/
	...
	echo '<div id="nav-top">';
	echo '<a href="' . CalRoot . '/index.php?b=0' . $locSaver . '" title="' . $hc_lang_event['ALTBrowseW'] . '" class="nav"><img src="' . CalRoot . '/images/nav/weekly.png" alt="' . $hc_lang_event['ALTBrowseW'] . '" /></a>';
	echo ' <a href="' . CalRoot . '/index.php?b=1' . $locSaver . '" title="' . $hc_lang_event['ALTBrowseM'] . '" class="nav"><img src="' . CalRoot . '/images/nav/monthly.png" alt="' . $hc_lang_event['ALTBrowseM'] . '" /></a>';
	...
	if(hasRows($result)){
		...
		echo '<ol>';
		echo '<li style="line-height:30px;"><div class="hc_align">' . $hc_lang_event['NoEvent1'] . '</div>&nbsp;<span class="miniCalEvents" style="padding:3px;">03</span></li>';
		echo '<li style="line-height:30px;"><div class="hc_align">' . $hc_lang_event['NoEvent2'] . '</div>&nbsp;<span class="miniCalNav" style="padding:3px;">&lt;</span> <span class="miniCalNav" style="padding:3px;">&gt;</span></li>';
