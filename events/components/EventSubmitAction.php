...
*/
	...
	$eventDesc = htmlspecialchars($_POST['eventDescription']);
	...
	if(isset($_POST['adminmessage'])){
		$adminMessage = "'" . htmlspecialchars($_POST['adminmessage']) . "'";
	} else {
		$adminMessage = "NULL";
	}//end if
	...
	//this is a recurring event
		...
		foreach ($dates as $val){
			...
			$query = "	INSERT INTO " . HC_TblPrefix . "events(Title, LocationName, LocationAddress, LocationAddress2, 
						...
						VALUES('" . $eventTitle . "', '" . $locName . "', '" . $locAddress . "', '" . $locAddress2 . "',
								'" . $locCity . "', '" . $locState . "', '" . $locZip . "', '" . $eventDesc . "',
								'" . $eventDate . "', " . $startTime . ", " . $tbd . ", " . $endTime . ",
								'" . $contactName . "', '" . $contactEmail . "', '" . $contactPhone . "', '" . $contactURL . "',
								1, 2, 0, '" . $subName . "', '" . $subEmail . "', now(), '" . $eventID . "',
								'" . $allowRegistration . "', '" . $maxRegistration . "', " . $adminMessage . ");";
