...
*/
	...
	$appStatus = 2;	//1 = Auto Approve, 2 = Pending (Default)
	...
	if(isset($_POST['recurCheck'])){
		...
		if((count($dates) + $curSubmit) >= $maxSubmit){
			exit("Thank you for your interest in submitting events. Unfrotunately you've reached the maximum number you can submit at this time.");
		} else {
	...
	if(mysql_result($result,0,0) == 1){
		...
		$subject = CalName . " -- New Event";
		
		$message = "There has been a new submission made to your Helios Calendar. A brief summary of this event is below. You can login to your Helios admin now to review the new event.<br><br>";
		$message .= "Submitted by: " . $subName . " - " . $subEmail . "<br><br>";
		$message .= "Event Title: " . $eventTitle . "<br><br>" . $eventDesc;
