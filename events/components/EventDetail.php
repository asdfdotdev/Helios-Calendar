...
<?php	if($eventDesc != ''){	?>
			<div id="eventDetailDesc" class="description"><?php echo nl2br($eventDesc);?></div>
<?php	}//end if	?>
...
<?php	if($eventStartTime != ''){
			...
			$startTime = "<abbr class=\"dtstart\" title=\"" . stampToDate($eventDate, "Ymd") . "T" . $microStartTime . "\">" . date($hc_timeFormat, mktime($timepart[0], $timepart[1], $timepart[2])) . "</abbr>";
		}//end if
		...
		if($eventEndTime != ''){
			...
			$endTime = "<abbr class=\"dtstart\" title=\"" . $microEndDate . "T" . $microEndTime . "\">" . date($hc_timeFormat, mktime($timepart[0], $timepart[1], $timepart[2])) . "</abbr>";
		}//end if
		...
		<abbr class="dtend" title="<?php echo stampToDate($eventDate, "Ymd") . "T" . $microStartTime;?>"></abbr>
		
<?php
		if($cost != ''){
			echo "<br /><div id=\"eventDetailHeader\">Cost:</div>" . $cost . "<br />";
		}//end if
		...
		if(hasRows($resultC)){
			echo "<br /><div id=\"eventDetailHeader\">Categories:</div>";
			while($row = mysql_fetch_row($resultC)){
				echo "<li class=\"category\"><a href=\"" . CalRoot . "/index.php?com=searchresult&t=" . $row[0] . "\" class=\"eventMain\">" . $row[1] . "</a></li><br />";
			}//end while
		}//end if	?>
		
		<br />
		<div id="eventDetailHeader" class="vcard">Location:&nbsp;
<?php	if($locAddress != '' &&
			$locCity != '' &&
			$locState != '' &&
			$locZip != ''){	?>
...
<?php	}//end if
		if($locPhone != ''){
			echo "<br /><div style=\"width:50px;float:left;\">Phone:&nbsp;</div><div class=\"tel\">" . $locPhone . "</div>";
		}//end if
...
<?php	}//end if
		if($locID > 0){
			echo "<br /><br /><a href=\"" . CalRoot . "/index.php?lID=" . $locID . "\" class=\"eventMain\">Browse Events At This Location</a>";
		}//end if
		...
		if(($contactURL != '' && $contactURL != 'http://') || ($contactName != '') 
			...
			|| ($contactPhone != '')){?>
			<br />
			<div id="eventDetailHeader">Contact:</div>
	...
	<?php
		...
		<div class="eventDetailToolbox">
			...
			<a target="_blank" class="eventShare" href="http://www.google.com/bookmarks/mark?op=add&amp;bkmk=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;title=<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/google.png" alt="Bookmark this on google" title="Bookmark this on google" align="absmiddle" /></a>
			<a target="_blank" class="eventShare" href="http://del.icio.us/post?url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;title=<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/delicious.png" alt="Bookmark this on del.icio.us" title="Bookmark this on del.icio.us" align="absmiddle" /></a>
			<a target="_blank" class="eventShare" href="http://digg.com/submit?phase=2&amp;url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>"><img src="<?php echo CalRoot;?>/images/share/digg.png" alt="Submit this to digg" title="Submit this to digg" align="absmiddle" /></a>
			<a target="_blank" class="eventShare" href="http://myweb2.search.yahoo.com/myresults/bookmarklet?u=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;t=<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/yahoo.png" alt="Bookmark this at yahoo" title="Bookmark this at yahoo" align="absmiddle" /></a>
			<a target="_blank" class="eventShare" href="http://reddit.com/submit?url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;title=<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/reddit.png" alt="reddit" title="reddit" align="absmiddle" /></a>
			<a target="_blank" class="eventShare" href="http://www.facebook.com/share.php?u=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;t=<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/facebook.png" alt="facebook" title="facebook" align="absmiddle" /></a>
			...
			<div id="eventDetailShareMore" style="display:none;">
				...
				<a target="_blank" class="eventShare" href="http://www.blinkbits.com/bookmarklets/save.php?v=1&amp;source_url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;title=<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/blinkbits.png" alt="blink bits" title="blink bits" /></a>
				<a target="_blank" class="eventShare" href="http://www.blinklist.com/index.php?Action=Blink/addblink.php&amp;Title=<?php echo urlencode($eventTitle);?>&amp;Url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>"><img src="<?php echo CalRoot;?>/images/share/blinklist.png" alt="blinklist" title="blinklist" /></a>
				...
				<a target="_blank" class="eventShare" href="http://www.dotnetkicks.com/kick/?url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&title<?php echo urlencode($eventTitle);?>&description=DESCRIPTION"><img src="<?php echo CalRoot;?>/images/share/dotnetkicks.png" alt="dotnetkicks" title="dotnetkicks" /></a>
				...
				<a target="_blank" class="eventShare" href="http://www.furl.net/storeIt.jsp?u=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;t=<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/furl.png" alt="Bookmark this at furl" alt="furl" title="furl" /></a>
				<a target="_blank" class="eventShare" href="http://www.givealink.org/cgi-pub/bookmarklet/bookmarkletLogin.cgi?&amp;uri=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;title=<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/givealink.png" alt="givealink" title="givealink" /></a>
				...
				<a target="_blank" class="eventShare" href="http://www.indiagram.com/mock/bookmarks/desitrain?action=add&amp;address=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;title<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/indiagram.png" alt="indiagram" title="indiagram" /></a>
				<a target="_blank" class="eventShare" href="http://kick.ie/submit/?url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&title<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/kick.png" alt="kick" title="kick" /></a>
				...
				<a target="_blank" class="eventShare" href="http://www.rawsugar.com/tagger/?turl=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;tttl<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/rawsugar.png" alt="rawsugar" title="rawsugar" /></a>
				...
				<a target="_blank" class="eventShare" href="http://www.shadows.com/shadows.aspx?url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>"><img src="<?php echo CalRoot;?>/images/share/shadows.png" alt="shadows" title="shadows" /></a>
				...
				<a target="_blank" class="eventShare" href="http://www.stumbleupon.com/submit?url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>"><img src="<?php echo CalRoot;?>/images/share/stumbleit.png" alt="stumble upon" title="stumble upon" /></a>
		...
		<?php
			...
			var calObj = new HCal("<?php echo $liveClipLink;?>", "<?php echo strip_tags(cleanXMLChars($eventTitle));?>", "<?php echo cleanXMLChars(strip_tags($eventDesc));?>", "<?php echo $startDate;?>", "<?php echo $endDate;?>", "<?php echo stampToDate($eventDate, $hc_dateFormat) . ", " . $eventStartTime;?>", "<?php echo cleanXMLChars(strip_tags(str_replace("<br />",", ",$locTag)));?>", "", "", "<?php echo date("Ymd\THis");?>", "<?php echo $eventEndTime;?>");   
	...
	<?php	$result = doQuery("SELECT PkID, StartDate FROM " . HC_TblPrefix . "events WHERE SeriesID = '" . $seriesID . "' AND StartDate >= '" . date("Y-m-d") . "' ORDER BY StartDate LIMIT 5");
			if(hasRows($result)){
