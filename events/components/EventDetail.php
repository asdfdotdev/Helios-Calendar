					...
					<table cellpadding="0" cellspacing="0" border="0" width="100%">
								...
								<table cellpadding="0" cellspacing="0" border="0">
									<tr>
										...
										<?	if(mysql_result($result,0,14) != '' || mysql_result($result,0,13) != ''){?>
											<a href="<?echo CalRoot;?>/link/SaveContact.php?eID=<?echo mysql_result($result,0,0);?>"><img src="<?echo CalRoot;?>/images/icons/contact.gif" width="15" height="13" alt="" border="0"></a>
										<?	}//end if?>
										</td>
									</tr>
								</table>
						...
						<?	}//end if ?>
							...
							<?	if(mysql_result($result,0,25) == 1){?>
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											<td width="25"><img src="<?echo CalRoot;?>/images/icons/clipboard.gif" width="20" height="20" alt="" border="0"></td>
							...
							<?	if($showDrive == 1){
								?>
									...
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											<td width="25"><img src="<?echo CalRoot;?>/images/icons/globe.gif" width="20" height="20" alt="" border="0"></td>
							...
							<?}//end if?>
								...
								<br>
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											<td width="25"><img src="<?echo CalRoot;?>/images/icons/calendar.gif" width="20" height="20" alt="" border="0"></td>
								...
								<br>
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											<td width="25"><img src="<?echo CalRoot;?>/images/icons/email.gif" width="20" height="20" alt="" border="0"></td>
							...
							<?	if(mysql_result($result,0,7) != ''){?>
								<br>
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											<td width="25"><img src="<?echo CalRoot;?>/images/icons/weather.gif" width="20" height="20" alt="" border="0"></td>
