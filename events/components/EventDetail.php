...
*/
	...
	if(hasRows($result)){
		...
		if($locID > 0){
			...
			if(hasRows($result)){
				...
				$locLink = "<a href=\"" . CalRoot . "/link/index.php?tID=2&amp;oID=" . $eID . "&amp;lID=" . $locID . "\" target=\"_blank\" class=\"eventDetailToolbox\">Click For Directions</a>";
			}//end if
		}//end if
		...
		<script language="JavaScript" type="text/javascript">document.title = "<?echo $eventTitle;?> :: " + document.title;</script>
	...
	<?	if($locName != ''){
			echo "<br /><b>Location</b><br />" . $locName . "<br />";
	...
	<?	}//end if
		...
		if($locURL != '' && $locURL != 'http://'){	?>
			<br />Website: <a href="<?echo CalRoot;?>/link/index.php?tID=4&amp;oID=<?echo $locID;?>" target="_blank" class="eventMain">Click to Visit</a>
	<?	}//end if
		if($locDesc != ''){
		...
		if(($contactURL != '' && $contactURL != 'http://') || ($contactName != '') 
			...
			|| ($contactPhone != '')){?>
			<br /><br />
			<b>Contact</b> <?if($contactName != '' || $contactEmail != ''){?><a href="<?echo CalRoot;?>/link/SaveContact.php?eID=<?echo $eID;?>" title="Download Event Contact vCard"><img src="<?echo CalRoot;?>/images/icons/iconContact.gif" alt="Download Event Contact vCard" border="0" /></a><?}?><br />
		<?	if($contactName != '' || $contactEmail){?>
			...
			if(($contactURL != '' && $contactURL != 'http://')){	?>
				Website: <a href="<?echo CalRoot . "/link/index.php?tID=1&amp;oID=" . $eID;?>" class="eventMain" target="_blank">Click to Visit</a>
		<?	}//end if	?>
...
<?php
	if($cost != ''){
		echo "<div class=\"eventDetailPrice\"><b>Cost:</b> " . $cost . "</div><br />";
	}//end if	?>
...
<?	}//end if
	...
	if($locAddress != '' &&
		...
		$locState != '' &&
		$locZip != ''){	?>
		<a href="<?echo CalRoot;?>/link/index.php?tID=2&amp;oID=<?echo $eID;if($locID > 0){echo "&amp;lID=" . $locID;}?>" target="_blank" class="eventDetailToolbox"><img class="eventDetailToolbox" src="<?echo CalRoot;?>/images/icons/iconGlobe.gif" width="16" height="16" alt="" border="0" /> Get Driving Directions</a><br />
<?	}//end if
	if($locZip != ''){?>
		<a href="<?echo CalRoot;?>/link/index.php?tID=3&amp;oID=<?echo $eID;if($locID > 0){echo "&amp;lID=" . $locID;}?>" class="eventDetailToolbox" target="_blank"><img class="eventDetailToolbox" src="<?echo CalRoot;?>/images/icons/iconWeather.gif" width="16" height="16" alt="" border="0" /> Current Weather Conditions</a><br />
<?	}//end if	?>
