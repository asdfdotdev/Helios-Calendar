		...
		<td class="eventMain">
			<?php
				...
				<img src="<?echo CalRoot;?>/images/spacer.gif" width="1" height="5" alt="" border="0"><br>
					...
					<b><?echo mysql_result($result,0,1);?></b><br>
					<table cellpadding="0" cellspacing="0" border="0" width="100%">
						<tr>
							<td width="10">&nbsp;</td>
							<td class="eventMain">
								<?
									if(mysql_result($result,0,8) != ''){
										echo str_replace(chr(13),'<br>',mysql_result($result,0,8)) . "<br><br>";
									}//end if
								?>
							</td>
						</tr>
											...
											<table cellpadding="0" cellspacing="0" border="0">
												<tr>
													...
													<?if(mysql_result($result,0,14) != '' || mysql_result($result,0,13) != ''){?>
															<?if(mysql_result($result,0,13) != ''){echo mysql_result($result,0,13);}?>
															<?if(mysql_result($result,0,14) != ''){?>
																<script language="JavaScript">
																<?
																	$eParts = explode("@", mysql_result($result,0,14));
														...
														if(mysql_result($result,0,15) != ''){
															echo mysql_result($result,0,15) . "<br>";
														}//end if
