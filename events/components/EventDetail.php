...
<?php	}//end if
	...
	<?php
		...
		<div class="eventDetailToolbox">
			...
			<a class="eventShare" href="http://reddit.com/submit?url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;title=<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/reddit.png" alt="reddit" title="reddit" align="absmiddle" /></a>
			<a class="eventShare" href="http://www.facebook.com/share.php?u=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;t=<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/facebook.png" alt="facebook" title="facebook" align="absmiddle" /></a>
			...
			<div id="eventDetailShareMore" style="display:none;">
				...
				<a class="eventShare" href="http://co.mments.com/track?url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;title<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/co.mments.png" alt="co.mments" title="co.mments" /></a>
				...
				<a class="eventShare" href="http://www.dotnetkicks.com/kick/?url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&title<?php echo urlencode($eventTitle);?>&description=DESCRIPTION"><img src="<?php echo CalRoot;?>/images/share/dotnetkicks.png" alt="dotnetkicks" title="dotnetkicks" /></a>
				...
				<a class="eventShare" href="http://extension.fleck.com/?v=b.0.804&&url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>"><img src="<?php echo CalRoot;?>/images/share/fleck.png" alt="fleck" title="fleck" /></a>
				<a class="eventShare" href="http://www.furl.net/storeIt.jsp?u=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;t=<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/furl.png" alt="Bookmark this at furl" alt="furl" title="furl" /></a>
				...
				<a class="eventShare" href="http://www.gwar.pl/DodajGwar.html?u=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>"><img src="<?php echo CalRoot;?>/images/share/gwar.png" alt="gwar" title="gwar" /></a>
				<a class="eventShare" href="http://www.hemidemi.com/user_bookmark/new?title<?php echo urlencode($eventTitle);?>&url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>"><img src="<?php echo CalRoot;?>/images/share/hemidemi.png" alt="hemidemi" title="hemidemi" /></a>
				<a class="eventShare" href="http://www.indiagram.com/mock/bookmarks/desitrain?action=add&amp;address=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;title<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/indiagram.png" alt="indiagram" title="indiagram" /></a>
				<a class="eventShare" href="http://kick.ie/submit/?url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&title<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/kick.png" alt="kick" title="kick" /></a>
				...
				<a class="eventShare" href="http://www.linkter.hu/index.php?action=suggest_link&amp;url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;title<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/linkter.png" alt="linkter" title="linkter" /></a>
				...
				<a class="eventShare" href="http://www.mister-wong.com/index.php?action=addurl&amp;bm_url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;bm_description<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/mister-wong.png" alt="mister-wong" title="mister-wong" /></a>
				<a class="eventShare" href="http://myshare.url.com.tw/index.php?func=newurl&url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&desc<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/myshare.png" alt="myshare" title="myshare" /></a>
				<a class="eventShare" href="http://www.netscape.com/submit/?U=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;T<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/netscape.png" alt="netscape" title="netscape" /></a>
				...
				<a class="eventShare" href="http://www.ppnow.net/submit.php?url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>"><img src="<?php echo CalRoot;?>/images/share/ppnow.png" alt="ppnow" title="ppnow" /></a>
				<a class="eventShare" href="http://www.rawsugar.com/tagger/?turl=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;tttl<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/rawsugar.png" alt="rawsugar" title="rawsugar" /></a>
				...
				<a class="eventShare" href="http://www.smarking.com/editbookmark/?url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;description<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/smarking.png" alt="smarking" title="smarking" /></a>
				<a class="eventShare" href="http://www.sphere.com/search?q=sphereit:<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;title<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/sphere.png" alt="sphere" title="sphere" /></a>
				...
				<a class="eventShare" href="http://www.webride.org/discuss/split.php?uri=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>&amp;title<?php echo urlencode($eventTitle);?>"><img src="<?php echo CalRoot;?>/images/share/webride.png" alt="webride" title="webride" /></a>
				...
				<a class="eventShare" href="http://www.wykop.pl/dodaj?url=<?php echo urlencode(CalRoot . '/index.php?com=detail&eID=' . $eID);?>"><img src="<?php echo CalRoot;?>/images/share/wykop.png" alt="wykop" title="wykop" /></a>
