									...
									<tr>
										...
										<?php
											if(mysql_result($result,0,2) != ''){
												echo cOut(mysql_result($result,0,2));
											}//end if
											if(mysql_result($result,0,3) != ''){
												echo "<br>" . cOut(mysql_result($result,0,3));
											}//end if
											if(mysql_result($result,0,4) != ''){
												$locAddress2 = mysql_result($result,0,4);
												echo "<br>" . cOut($locAddress2);
											}//end if
											if(mysql_result($result,0,5) != ''){
												echo "<br>" . cOut(mysql_result($result,0,5));
											...
											<table cellpadding="0" cellspacing="0" border="0">
												<tr>
													...
													<?if(mysql_result($result,0,14) != '' || mysql_result($result,0,13) != ''){?>
															<?if(mysql_result($result,0,13) != ''){echo cOut(mysql_result($result,0,13));}?>
															<?if(mysql_result($result,0,14) != ''){?>
																...
																?>
																	...
																	document.write('<br><a href="mailto:' + ename + '@' + edomain + '.' + eext + '" class="eventMain">' + ename + '@' + edomain + '.' + eext + '</a>');
																</script>
															<?}//end if
														}//end if
														
														if(mysql_result($result,0,15) != ''){
															echo "<br>" . cOut(mysql_result($result,0,15));
														}//end if
														
														if((mysql_result($result,0,24) != '' && mysql_result($result,0,24) != 'http://')){	?>
															<br><a href="<?echo CalRoot . "/link/?tID=1&oID=" . mysql_result($result,0,0);?>" class="eventMain" target="_blank">Visit Website</a>
													<?	}//end if	?>
													</td>
												</tr>
											</table>
