...
?>	<b>Your Search Results</b> [<a href="<?echo CalRoot;?>/index.php?com=searchresult&s=<?php echo urlencode($startDate);?>&e=<?php echo urlencode($endDate);?>&k=<?php echo urlencode($keyword) . $linkL . $linkC . $linkCat;?>" class="eventMain">Link to These Results</a>]<br>
	<?php
