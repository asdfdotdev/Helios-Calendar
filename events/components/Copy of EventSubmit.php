...
*/
	if($hc_pubSubmit == 1){
		...
		<?	}//end if	?>
				...
				} else if((document.frmEventSubmit.startTimeHour.value > <?echo $hc_timeInput;?>) || (document.frmEventSubmit.startTimeHour.value < <?echo $minHr;?>)) {
					dirty = 1;
				...
				} else if((document.frmEventSubmit.endTimeHour.value > <?echo $hc_timeInput;?>) || (document.frmEventSubmit.endTimeHour.value < <?echo $minHr;?>)) {
					dirty = 1;
			...
			function chkDate(){
				...
				} else if(!isDate(document.frmEventSubmit.eventDate.value, '<?echo $hc_popDateValid;?>')){
			...
			function chkRecur(){
				...
				} else if(!isDate(document.frmEventSubmit.recurEndDate.value, '<?echo $hc_popDateValid;?>')){
			...
			function confirmRecurDates(){
				if(document.frmEventSubmit.recurCheck.checked){
					...
					if(dirty > 0){
						...
						qStr = qStr + '&dateFormat=<?echo $hc_popDateFormat;?>&eventDate=' + document.frmEventSubmit.eventDate.value + '&recurEndDate=' + document.frmEventSubmit.recurEndDate.value;
						
						//document.getElementById('recurDateChk').innerHTML = qStr;
						//return false;
		...
		<?	if(in_array(1, $hc_captchas)){	?>
				<fieldset>
					...
					If you cannot read the text you may reload this page to generate a new image.
					<div class="frmOpt">
						<label>&nbsp;</label>
					<?php	buildCaptcha();	?><br />
					</div>
					<div class="frmOpt">
						<label>&nbsp;</label>
						<input name="proof" id="proof" type="text" maxlength="8" size="8" value="" onblur="alert('Please verify you have entered the authentication text correctly or you will have to re-enter your event to submit it.');" />
		...
		<?	}//end if	?>
			<fieldset>
				...
				<div class="frmOpt">
					...
					<?makeTinyMCE("eventDescription", $hc_WYSIWYG, "375px");?>
			    </div>
				<div class="frmReq">
				...
				<div class="frmOpt">
					...
					<table cellpadding="1" cellspacing="0" border="0">
						<tr>
							...
							<td><a href="javascript:;" onclick="chngClock(document.frmEventSubmit.startTimeHour,1,<?echo $hc_timeInput;?>)"><img src="<?echo CalRoot;?>/images/time_up.gif" width="16" height="8" alt="" border="0" /></a><br /><a href="javascript:;" onclick="chngClock(document.frmEventSubmit.startTimeHour,-1,<?echo $hc_timeInput;?>)"><img src="<?echo CalRoot;?>/images/time_down.gif" width="16" height="9" alt="" border="0" /></a></td>
				...
				<div class="frmOpt">
					...
					<table cellpadding="1" cellspacing="0" border="0">
						<tr>
							...
							<td><a href="javascript:;" onclick="chngClock(document.frmEventSubmit.endTimeHour,1,<?echo $hc_timeInput;?>)"><img src="<?echo CalRoot;?>/images/time_up.gif" width="16" height="8" alt="" border="0" /></a><br /><a href="javascript:;" onclick="chngClock(document.frmEventSubmit.endTimeHour,-1,<?echo $hc_timeInput;?>)"><img src="<?echo CalRoot;?>/images/time_down.gif" width="16" height="9" alt="" border="0" /></a></td>
						...
						<tr>
							...
							<td style="vertical-align: top;">
								...
								<div class="recPanel" id="monthly" style="display: none;">
									<input name="monthlyOption" id="monthlyOption1" type="radio" checked="checked" value="Day" class="noBorderIE" />Day&nbsp;<input name="monthlyDays" id="monthlyDays" type="text" maxlength="2" size="2" value="<?echo date("d");?>" />&nbsp;of every&nbsp;<input name="monthlyMonths" id="monthlyMonths" type="text" maxlength="2" size="2" value="1" />&nbsp;month(s)<br />
			...
			<br />
		<?	if(isset($hc_pubCat) && $hc_pubCat == 1){	?>
			<fieldset>
				<legend>Event Categories</legend>
				<div class="frmOpt">
					<label>Categories:</label>
					<?getCategories('frmEventSubmit', 2);?>
				</div>
			</fieldset>
			<br />
		<?	}//end if	?>
