...
*/
	...
	<?php	if(in_array(1, $hc_captchas)){	?>
			...
			<?php	buildCaptcha();	?><br />
				...
				<div class="frmReq">
					<label for="proof"><?php echo $hc_lang_event['ImageText'];?></label>
