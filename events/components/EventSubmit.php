		...
		if(!isset($_GET['msg'])){	
			...
			function chngClock(obj,inc,maxVal){
				if(obj.disabled == false){
					...
					if(maxVal == 59){
						if(val > maxVal) val = 0;
						if(val < 0) val = maxVal + 1 - Math.abs(val);
					} else {
	...
	<?php	if($hc_cfg65 > 0 && in_array(1, $hc_captchas)){
			...
			<?php	makeTinyMCE('eventDescription', '80%');?>
				...
				<div class="frmOpt">
					...
					<div class="eventStartH"><input name="startTimeHour" id="startTimeHour" type="text" value="<?php echo date($hrFormat);?>" size="2" maxlength="2" class="eventTimeInput" /></div>
					...
					<div class="eventStartM"><input name="startTimeMins" id="startTimeMins" type="text" value="00" size="2" maxlength="2" class="eventTimeInput" /></div>
			...
			<?php 	}//end if	?>
				...
				<div class="frmOpt">
					...
					<div class="eventEndH"><input name="endTimeHour" id="endTimeHour" type="text" value="<?php echo date($hrFormat, mktime(date($hrFormat) + 1, 0, 0, 1, 1, 1971));?>" size="2" maxlength="2" class="eventTimeInput" /></div>
					...
					<div class="eventEndM"><input name="endTimeMins" id="endTimeMins" type="text" value="00" size="2" maxlength="2" class="eventTimeInput" /></div>
...
<?php 	} else {
			...
			echo '<p>' . $hc_lang_event['ThankYou'] . '</p>';
			echo '<p><a href="' . CalRoot . '/index.php?com=submit" class="eventMain">' . $hc_lang_event['ClickSubmitAgain'] . '</a></p>';
			echo '<p><a href="' . CalRoot . '/" class="eventMain">' . $hc_lang_event['ClickToBrowse'] . '</a></p>';
			echo '</div>';
 		}//end if
	} else {
