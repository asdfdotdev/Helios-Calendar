...
*/
	...
	<?php 	}//end if	?>
		...
		<?php 	}//end if	?>
				...
				if(compareDates(document.frmEventSubmit.eventDate.value, '<?php echo $hc_popDateValid;?>', '<?php echo date($hc_popDateFormat, mktime(0, 0, 0, date("m"), date("d") - 1, date("Y")) );?>', '<?php echo $hc_popDateValid;?>') == 0){
					dirty = 1;
