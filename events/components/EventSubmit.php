		...
		if(!isset($_GET['msg'])){	
			...
			function togRecur(){
				if(document.frmEventSubmit.recurCheck.checked){
					...
					document.frmEventSubmit.recWeeklyDay_7.disabled = false;
					...
					document.frmEventSubmit.recWeeklyDay_7.disabled = true;
						...
						<tr>
							...
							<td style="vertical-align: top;">
								...
								<div class="recPanel" id="weekly" style="display: none;">
									...
									<br />
										<input id="recWeeklyDay_1" name="recWeeklyDay[]" type="checkbox" class="noBorderIE" />Sun
										<input id="recWeeklyDay_2" name="recWeeklyDay[]" type="checkbox" class="noBorderIE" />Mon
										<input id="recWeeklyDay_3" name="recWeeklyDay[]" type="checkbox" class="noBorderIE" />Tue
										<input id="recWeeklyDay_4" name="recWeeklyDay[]" type="checkbox" class="noBorderIE" />Wed<br />
										<input id="recWeeklyDay_5" name="recWeeklyDay[]" type="checkbox" class="noBorderIE" />Thu
										<input id="recWeeklyDay_6" name="recWeeklyDay[]" type="checkbox" class="noBorderIE" />Fri
										<input id="recWeeklyDay_7" name="recWeeklyDay[]" type="checkbox" class="noBorderIE" />Sat
								</div>
