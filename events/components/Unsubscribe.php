...
*/
	...
	if(hasRows($result)){
		...
		<br /><br />
		<b>To cancel <a href="<?echo CalRoot;?>" class="eventMain">leave this page now</a>.</b>
		<br /><br />
		If you wish to resubscribe later you may do so here at the <?echo CalName;?> website.
		<br /><br />
