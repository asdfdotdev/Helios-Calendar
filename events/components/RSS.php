...
*/
	...
	<div id="rssMenu">
		<ul>
			<li><a href="<?php echo CalRoot;?>/index.php?com=rss&amp;rID=2" class="eventMain">What is RSS?</a></li>	
			<li><a href="<?php echo CalRoot;?>/index.php?com=rss&amp;rID=1" class="eventMain">Popular RSS Readers</a></li>
			<li><a href="<?php echo CalRoot;?>/index.php?com=rss&amp;rID=3" class="eventMain">Usage Guidelines</a></li>
			<li><a href="<?php echo CalRoot;?>/index.php?com=rss" class="eventMain">Our Feeds</a></li>
		</ul>
	</div>
<?php 
	switch($rID){
		case 0:	?>
			...
			//<!--
				function updateLink(){
					document.frmEventRSS.rssLink.value = '<?php echo CalRoot;?>/rss.php?cID=' + checkUpdateString('frmEventRSS', 'catID[]') + '&c=' + encodeURI(checkUpdateString('frmEventRSS', 'cityName[]'));
				}//end updateLink()
			//-->
			</script>
			...
			<div class="rssSynd">
				...
				<a href="http://fyuze.com/add/rss/<?php echo CalRoot;?>/rss.php" class="rssSynd" target="_blank"><img src="<?php echo CalRoot;?>/images/rss/synd_fyuze.gif" width="91" height="17" alt="" border="0" />&nbsp;</a><br />
			...
			<div class="rssSynd">
				...
				<a href="http://www.newsburst.com/Source/?add=<?php echo CalRoot;?>/rss.php" class="rssSynd target="_blank"><img src="<?php echo CalRoot;?>/images/rss/synd_newsburst.gif" width="91" height="17" alt="" border="0" />&nbsp;</a><br />
				<a href="http://www.newsisfree.com/user/sub/?url=<?php echo CalRoot;?>/rss.php" class="rssSynd" target="_blank"><img src="<?php echo CalRoot;?>/images/rss/synd_newsisfree.gif" width="91" height="17" alt="" border="0" />&nbsp;</a><br />
			...
			<div class="rssSynd">
				<a href="http://client.pluck.com/pluckit/prompt.aspx?a=<?php echo CalRoot;?>/rss.php" class="rssSynd" target="_blank"><img src="<?php echo CalRoot;?>/images/rss/synd_pluck.gif" width="91" height="17" alt="" border="0" />&nbsp;</a><br />
			...
			<fieldset>
				...
				<div class="frmOpt">
					<input readonly name="rssLink" id="rssLink" type="text" style="width:95%;" maxlength="200" value="<?php echo CalRoot;?>/rss.php" />
				</div>
			</fieldset>
			<br />
...
<?php 		break;
		...
		case 1:	?>
			...
			While we provide <a href="<?php echo CalRoot;?>/index.php?com=rss" class="eventMain">links to several popular online readers</a> there are also many popular downloadable readers which 
			...
			<br /><br />
			<a href="http://www.download.com/3120-20_4-0.html?qt=rss+reader&amp;tg=dl-2001&amp;search.x=30&amp;search.y=3&amp;search=+Go%21+" class="rssReader" target="_blank"><img class="rssReader" src="<?php echo CalRoot;?>/images/rss/logoWindows.jpg" width="33" height="30" alt="" border="0" />&nbsp;Visit Download.com</a>
			<br /><br />
			<a href="http://www.download.com/3120-20_4-0.html?tag=srch&amp;qt=rss+reader&amp;tg=dl-2003&amp;search.x=0&amp;search.y=0&search=+Go%21" class="rssReader" target="_blank"><img class="rssReader" src="<?php echo CalRoot;?>/images/rss/logoApple.jpg" width="25" height="30" alt="" border="0" />&nbsp;&nbsp;Visit Download.com</a>
			<br /><br />
			<a href="http://www.google.com/search?q=linux+rss+readers" class="rssReader" target="_blank"><img class="rssReader" src="<?php echo CalRoot;?>/images/rss/logoTux.jpg" width="25" height="30" alt="" border="0" />&nbsp;&nbsp;Find at Google</a>
			
<?php 		break;
		
		case 2:	?>
			<div class="rssTitle">What is RSS?</div>
			Really Simple Syndication (RSS) is an XML-based format for online content distribution. We utilizes an RSS 2.0 format to syndicate our event content.
			<br /><br />
...
<?php 		break;
		...
		case 3:	?>
			...
			If you publish <?php echo CalName;?> content via use of our RSS feeds, please provide attribution and a link back to our site.
			<br /><br />
			...
			<br /><br />
			Use of all <?php echo CalName;?> RSS feeds is left to our discretion and the terms that govern their use may be adjusted at anytime.
			<br /><br />
