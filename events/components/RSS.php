...
*/
	...
	//<!--
		function updateLink(){
			...
			document.frmEventRSS.rssLink.value = '<?php echo CalRoot;?>/rss/?' + catStr + cityStr;
		}//end updateLink()
	//-->
	</script>
	<br />
	...
	<fieldset>
		...
		<div class="frmOpt">
			<input readonly="readonly" name="rssLink" id="rssLink" type="text" style="width:95%;" maxlength="200" value="<?php echo CalRoot;?>/rss/" />
		</div>
	</fieldset>
	<br />
