...
<?	switch($rID){
		case 0:	?>
			...
			<div class="rssTitle">Subscribe to Our "All Events" Feed Feed</div>
			<div class="rssSynd">
			...
			<fieldset>
				...
				<div class="frmReq">
					<input name="rssLink" id="rssLink" type="text" size="75" maxlength="200" value="<?echo CalRoot;?>/rss.php" />
				</div>
			</fieldset>
			<br />
	...
	<?		break;
		...
		case 2:	?>
			...
			RDF Site Summary (RSS) is an XML-based format for online content distribution. The <?echo CalName;?> utilizes an RSS 2.0
			...
			<br />
			For a bit more techy description 
