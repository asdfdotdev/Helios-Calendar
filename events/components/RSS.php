	...
	switch($rID){
		case 0:	?>
			...
			<fieldset>
				...
				<div class="frmOpt">
					<input readonly name="rssLink" id="rssLink" type="text" size="75" maxlength="200" value="<?php echo CalRoot;?>/rss.php" />
				</div>
			</fieldset>
			<br />
...
<?php 		break;
		...
		case 2:	?>
			...
			Really Simple Syndication (RSS) is an XML-based format for online content distribution. The <?php echo CalName;?> utilizes an RSS 2.0
