		...
		$.extend($.multiUpload.prototype, {
			...
			init : function() {
				...
				$(document.body).append(
					...
					'<object id="flashuploader" width="100%" height="100%" type="application/x-shockwave-flash" data="js/jquery/jquery.multiupload.flash.swf?sux=' + (new Date().getTime()) + '">' +
					...
					'<param name="movie" value="js/jquery/jquery.multiupload.flash.swf?sux=' + (new Date().getTime()) + '" />' +
