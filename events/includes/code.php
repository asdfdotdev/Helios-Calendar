...
*/
	...
	function makeTinyMCE($textName, $hc_WYSIWYG = 1, $width = "435px", $style = "simple", $passContent = ""){	?>
		...
		//<!--
			tinyMCE.init({
				...
				plugins :  "spellchecker,advhr,advimage,advlink,emotions,fullscreen,inlinepopups,insertdatetime,layer,media,paste,preview,print,searchreplace,style,table,xhtmlxtras",
	...
	<?php 	}//end if	?>
			...
			tinyMCE.execCommand('mceFocus', false, 'webClipControl7');
			tinyMCE.execCommand('mceRemoveControl', false, 'webClipControl7');
		//-->
		</script>
		<!-- /tinyMCE -->
<?php
...
<?php	}//end if
	...
	function cleanXMLChars($textToClean){
		$textToClean = str_replace("&", "&#38;", $textToClean);
		$textToClean = str_replace("\"", "&quot;", $textToClean);
		$textToClean = str_replace("'", "&#39;", $textToClean);
		$textToClean = str_replace("<", "&lt;", $textToClean);
