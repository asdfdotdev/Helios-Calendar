<?php
	...
	function doQuery($query){
		$result = mysql_query(cleanQuery($query));
	...
	function makeTinyMCE($textName, $width = "100%", $style = "simple", $passContent = ""){?>	
		...
		<?	if($style == "advanced"){	?>
				theme_advanced_buttons1 : "fontsizeselect,bold,italic,strikethrough,separator,bullist,numlist,separator,justifyleft,justifycenter,justifyright,separator,undo,redo,code,separator,replace",
				theme_advanced_buttons2 : "pastetext,separator,outdent,indent,separator,link,unlink,anchor,separator,image,emotions,separator,forecolor,backcolor,separator,insertdate,separator,sup,sub,separator,cleanup",
...
<?	}//end makeHTMLArea()
	...
	function appInstructions($noSwitch, $title, $message){
						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								...
								<td class="instructionText">
									<b><?echo $title;?></b><br><?echo $message;?><br>
									<?php
										if($noSwitch == 0){
