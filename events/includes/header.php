...
*/
	...
	$result = doQuery("SELECT SettingValue FROM " . HC_TblPrefix . "settings WHERE PkID IN (1,5,6,7,10,11,12,13,14,15,21,22,23,24,26,27,29,30,31,32,33,34,35,45) ORDER BY PkID");
	...
	if(hasRows($result)){
		...
		$hc_LocBrowse = cOut(mysql_result($result,23,0));
...
<?php
	if(isset($hc_googleKey) && ((!isset($_GET['com']) && isset($_GET['lID']) && is_numeric($_GET['lID'])) || (isset($_GET['com']) && ($_GET['com'] == 'detail' || $_GET['com'] == 'location')))){	?>
