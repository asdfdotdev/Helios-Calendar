...
*/
	...
	if(!isset($_SESSION[$hc_cfg00 . 'isMobile'])){
		include_once('includes/mobile/Agents.php');
		if(!preg_match($hc_mobile,$_SERVER['HTTP_USER_AGENT']) || $hc_cfg48 == 0){
			$_SESSION[$hc_cfg00 . 'isMobile'] = 0;
		} else {
	...
	include($hc_langPath . $_SESSION[$hc_cfg00 . 'LangSet'] . '/public/core.php');
