...
'InstructDeleteR'	=>	'Select events from the list below by clicking the checkbox beside the listing. Once you have made your selection(s) click the "Delete Selected" button below to delete the events.',
...
'None01'			=>	'<b>You must have at least 2 events to create a series.</b><br /><a href="index.php?com=eventsearch&sID=3" class="main">Click here to search again.</a>',
...
//	Tooltips
'Tip01A'			=>	'Search Event Series',
'Tip01B'			=>	'Checking this box will limit the search results to only multiple date events (Event Series). Search results will show only the earliest active occurance of the event series.<br /><br />Using this search option can make it easier to locate a recurring event and edit all occurances within the event series.',
...
'Feed04'			=>	'Events updated &amp; submitted to Eventful successfully.',
'Feed05'			=>	'Event(s) deleted successfully. Eventful removal failed.',
'Feed06'			=>	'Event(s) deleted and removed from Eventful successfully.'
);?>