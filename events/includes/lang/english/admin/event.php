...
'LiveClipAdd'		=>	'Add Event Using Live Clipboard',
...
'InstructPendingA'	=>	'You can approve/decline events and send a message informing the event submitter of the event\'s status change by clicking on the <img src="http://localhost/helios/admin/images/icons/iconEdit.png" width="15" height="15" alt="" border="0" align="middle" /> icon beside the event. <br /><br />To approve/decline all pending events in a series, click the <img src="http://localhost/helios/admin/images/icons/iconEditGroup.png" width="15" height="15" alt="" border="0" align="middle" /> icon  atop the series listing.',
