 ...
 */
require_once "$OIDPath/Auth/OpenID.php";
require_once "$OIDPath/Auth/OpenID/Message.php";
require_once "$OIDPath/Auth/OpenID/HMAC.php";
require_once "$OIDPath/Auth/OpenID/Association.php";
require_once "$OIDPath/Auth/OpenID/CryptUtil.php";
require_once "$OIDPath/Auth/OpenID/DiffieHellman.php";
require_once "$OIDPath/Auth/OpenID/KVForm.php";
require_once "$OIDPath/Auth/OpenID/Nonce.php";
require_once "$OIDPath/Auth/OpenID/Discover.php";
require_once "$OIDPath/Auth/OpenID/URINorm.php";
require_once "$OIDPath/Auth/Yadis/Manager.php";
require_once "$OIDPath/Auth/Yadis/XRI.php";
