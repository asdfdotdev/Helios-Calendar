...
/*
	...
	NOTE:	If Your Public Helios Calendar is not stored in the events directory changes will need to be made
			to some include statements in the Helios admin. It is NOT recommended to rename the events directory.
*/
	...
	define("HC_TblPrefix", "hc_");	// Optional, But Strongly Recommended.
