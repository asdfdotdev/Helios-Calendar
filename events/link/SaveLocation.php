...
*/
	...
	if(hasRows($result)){
		...
		while($row = mysql_fetch_row($result)){
			...
			echo "SUMMARY:" . html_entity_decode(cOut(cleanSpecialChars(strip_tags($summary)))) . "\n";
			echo "DESCRIPTION:" . html_entity_decode(cOut(cleanSpecialChars(htmlentities(strip_tags(cleanBreaks($description)))))) . $descFooter . "\n";
			echo "LOCATION:" . html_entity_decode(cOut($location)) . "\n";
