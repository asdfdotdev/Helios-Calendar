		...
		<?	} else {
				...
				switch($_POST['uID']){
					...
					case 1:	
						...
						$result = doQuery("SELECT Phone FROM " . HC_TblPrefix . "registrants WHERE Title = 'helios_upgrade'");
						if(hasRows($result)){
							if(mysql_result($result,0,0) == 'abcdefghijklmnopqrstuvwxy'){
								echo "...Successful";
							} else {
						...
						doQuery("DELETE FROM " . HC_TblPrefix . "registrants WHERE Title = 'helios_upgrade'");
