...
*/
	...
	<br />
	<div style="float:left;width:58%;padding:0px 5px 0px 0px;">
	...
	<fieldset style="padding-top:5px;">
		<legend><?php echo $whereAmI; if($cID > 0){ echo '&nbsp;&nbsp;( <a href="' . CalAdminRoot . '/index.php?com=categorymanage" class="main">' . $hc_lang_manage['AddNew'] . '</a> )';}?></legend>
		<div class="frmReq">
	...
	<div style="float:left;width:40%;padding:0px 5px 0px 0px;">
<?php 	
