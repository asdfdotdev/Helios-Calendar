...
*/
	...
	<?php 	}//end if	?>
		...
		<?php
			makeTinyMCE('descript', '525px', 'advanced', $hc_cfg24, $descript);?>
		</div>
	</fieldset>
	<?php
	...
	if(hasRows($result)){
		...
		<?php
			...
			if(hasRows($resultEF)){	?>
				...
				<div class="frmOpt">
					<label for="doEventful" class="radioWide"><input name="doEventful" id="doEventful" type="checkbox" onclick="toggleMe(document.getElementById('eventful'));" class="noBorderIE" />&nbsp;<?php echo $hc_lang_locations['EventfulUpdate'];?> <b><span style="color:#0043FF;">event</span><span style="color:#66CC33;">ful</span></b></label>
				</div>
		<?php
			} else {	?>
				...
				<div class="frmOpt">
					<label for="doEventful" class="radioWide"><input name="doEventful" id="doEventful" type="checkbox" onclick="toggleMe(document.getElementById('eventful'));" class="noBorderIE" />&nbsp;<?php echo $hc_lang_locations['EventfulAdd'];?> <b><span style="color:#0043FF;">event</span><span style="color:#66CC33;">ful</span></b></label>
				</div>		
		<?php
			}//end if	?>
