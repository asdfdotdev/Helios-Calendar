...
*/
	...
	if($impType == 0){
		...
		if($termChar != '' && $eventIn != ''){
			...
			echo "\n\r";
			echo "\"CSV Import Sample Event\",\"We\'re using a little html for this one...<br /><br /><b>this is bold</b>\, <i>this is italicized</i>\, <u>this is underlined</u>\, <strike>strike this!</strike> plus this one has commas. You can &quot;quote me on that&quot;\, or \'quote me on that\'. Whichever you prefer.\",\"Free\"," . date("Y-m-d") . ",07:00:00,18:00:00,0,0,\"Helios Calendar\'s Hometown\",\"\",,\"Hillsboro\",\"OR\",97124,\"USA\",\"Event Contact\",\"nothing@fake.edu\",\"555-123-4567\",\"http://www.helioscalendar.com\",0,,0,0";
			exit();
		}//end if
	} else {
		set_time_limit(300);
