...
*/
	...
	<?php
		...
		echo '<div style="line-height:20px;font-weight:bold;">' . stampToDate(mysql_result($result,0,5), $hc_cfg24 . ' @ ' . $hc_cfg23) . '</div></div>';
		...
		$result = doQuery("SELECT COUNT(Score) FROM hc_recomndslog WHERE Score > 0 AND OIDUser = ". cIn($uID));
