...
<?php 	}//end if	?>
	...
	function chkDate(){
		...
		} else if(!isDate(document.frmEventAdd.eventDate.value, '<?php echo $hc_cfg51;?>')){
	...
	function searchLocations($page){
		if(document.frmEventAdd.locSearch.value.length > 3){
			var qStr = 'LocationSearch.php?np=1&q=' + escape(document.frmEventAdd.locSearch.value) + '&o=' + $page;
	...
	<?php makeTinyMCE('eventDescription', '525px', 'advanced', $hc_cfg24);?>
		</div>
		<div class="frmReq">
