 ...
 */
	...
	$submit = cOut(hc_mysql_result($result,0,0));
	$rssMax = cOut(hc_mysql_result($result,1,0));
	$passApprove = cOut(hc_mysql_result($result,2,0));
	$passDecline = cOut(hc_mysql_result($result,3,0));
	$driving = cOut(hc_mysql_result($result,4,0));
	$weather = cOut(hc_mysql_result($result,5,0));
	$mostPopular = cOut(hc_mysql_result($result,6,0));
	$browsePast = cOut(hc_mysql_result($result,7,0));
	$maxShow = cOut(hc_mysql_result($result,8,0));
	$fillMax = cOut(hc_mysql_result($result,9,0));
	$dateFormat = cOut(hc_mysql_result($result,10,0));
	$showTime = cOut(hc_mysql_result($result,11,0));
	$state = cOut(hc_mysql_result($result,12,0));
	$calStartDay = cOut(hc_mysql_result($result,13,0));
	$timeFormat = cOut(hc_mysql_result($result,14,0));
	$popDateFormat = cOut(hc_mysql_result($result,15,0));
	$passAge = cOut(hc_mysql_result($result,16,0));
	$langType = cOut(hc_mysql_result($result,17,0));
	$userCat = cOut(hc_mysql_result($result,18,0));
	$WYSIWYG = cOut(hc_mysql_result($result,19,0));
	$timeInput = cOut(hc_mysql_result($result,20,0));
	$captchas = explode(",", cOut(hc_mysql_result($result,21,0)));
	$series = cOut(hc_mysql_result($result,22,0));
	$browseType = cOut(hc_mysql_result($result,23,0));
	$timezoneOffset = cOut(hc_mysql_result($result,24,0));
	$subLimit = cOut(hc_mysql_result($result,25,0));
	$stats = cOut(hc_mysql_result($result,26,0));
	$float = cOut(hc_mysql_result($result,27,0));
	$searchWindow = cOut(hc_mysql_result($result,28,0)) + 1;
	$pubNews = cOut(hc_mysql_result($result,29,0));
	$jssMax = cOut(hc_mysql_result($result,30,0));
	$capType = cOut(hc_mysql_result($result,31,0));
	$maxNew = cOut(hc_mysql_result($result,32,0));
	$reCapPub = cOut(hc_mysql_result($result,33,0));
	$reCapPriv = cOut(hc_mysql_result($result,34,0));
	$locSelect = cOut(hc_mysql_result($result,35,0));
	$mailMethod = cOut(hc_mysql_result($result,36,0));
	$mailHost = cOut(hc_mysql_result($result,37,0));
	$mailPort = cOut(hc_mysql_result($result,38,0));
	$mailSecure = cOut(hc_mysql_result($result,39,0));
	$mailUser = cOut(hc_mysql_result($result,40,0));
	$mailPass = base64_decode(cOut(hc_mysql_result($result,41,0)));
	$mailAuth = cOut(hc_mysql_result($result,42,0));
	$mailAddress = cOut(hc_mysql_result($result,43,0));
	$mailName = cOut(hc_mysql_result($result,44,0));
	$loginTries = cOut(hc_mysql_result($result,45,0));
	$batchSize = cOut(hc_mysql_result($result,46,0));
	$batchDelay = cOut(hc_mysql_result($result,47,0));
	$sitemap = cOut(hc_mysql_result($result,48,0));
	$iCalMax = cOut(hc_mysql_result($result,49,0));
	$iCalRef = cOut(hc_mysql_result($result,50,0));
	$reCapStyle = cOut(hc_mysql_result($result,51,0));
	$passStr = cOut(hc_mysql_result($result,52,0));
	$mc_select = cOut(hc_mysql_result($result,53,0));
	$mc_dow = cOut(hc_mysql_result($result,54,0));
	$rssStatus = cOut(hc_mysql_result($result,55,0));
	$rssTrunc = cOut(hc_mysql_result($result,56,0));
	$iCalStatus = cOut(hc_mysql_result($result,57,0));
	$iCalTrunc = cOut(hc_mysql_result($result,58,0));
	$sendPast = cOut(hc_mysql_result($result,59,0));
