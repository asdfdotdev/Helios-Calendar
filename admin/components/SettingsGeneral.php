...
<?	if (isset($_GET['msg'])){
	...
	$result = doQuery("SELECT SettingValue FROM " . HC_TblPrefix . "settings WHERE PkID IN (1,2,3,4,8,9,10,11,12,13,14,15,21,22,23,24,25,26,27,28) ORDER BY PkID");
	...
	<fieldset>
		...
		<div class="frmOpt">
			...
			<select name="weather" id="weather">
				<option <?if($weather == 0){echo "selected=\"selected\"";}//end if?> value="0">Weather.com</option>
				...
				<option <?if($weather == 5){echo "selected=\"selected\"";}//end if?> value="5">Weather.co.uk (UK)</option>
			</select>
		</div>
		<div class="frmOpt">
			...
			<select name="driving" id="driving">
				...
				<option <?if($driving == 3){echo "selected=\"selected\"";}//end if?> value="3">Google Maps (UK)</option>
			</select>
		</div>
	</fieldset>
	<br />
	<fieldset>
		...
		<div class="frmOpt">
			...
			<select name="mapZoom" id="mapZoom">
				<option <?if($mapZoom == 1){echo "selected=\"selected\"";}//end if?> value="1">01 - World</option>
				<option <?if($mapZoom == 2){echo "selected=\"selected\"";}//end if?> value="2">02</option>
				<option <?if($mapZoom == 3){echo "selected=\"selected\"";}//end if?> value="3">03 - Country</option>
				<option <?if($mapZoom == 4){echo "selected=\"selected\"";}//end if?> value="4">04</option>
				<option <?if($mapZoom == 5){echo "selected=\"selected\"";}//end if?> value="5">05 - State</option>
				<option <?if($mapZoom == 6){echo "selected=\"selected\"";}//end if?> value="6">06</option>
				<option <?if($mapZoom == 7){echo "selected=\"selected\"";}//end if?> value="7">07</option>
				<option <?if($mapZoom == 8){echo "selected=\"selected\"";}//end if?> value="8">08</option>
				<option <?if($mapZoom == 9){echo "selected=\"selected\"";}//end if?> value="9">09</option>
				<option <?if($mapZoom == 10){echo "selected=\"selected\"";}//end if?> value="10">10 - City</option>
				<option <?if($mapZoom == 11){echo "selected=\"selected\"";}//end if?> value="11">11</option>
				<option <?if($mapZoom == 12){echo "selected=\"selected\"";}//end if?> value="12">12</option>
				<option <?if($mapZoom == 13){echo "selected=\"selected\"";}//end if?> value="13">13</option>
				<option <?if($mapZoom == 14){echo "selected=\"selected\"";}//end if?> value="14">14</option>
				<option <?if($mapZoom == 15){echo "selected=\"selected\"";}//end if?> value="15">15 - Street</option>
			</select>
		</div>
	</fieldset>
	<br />
