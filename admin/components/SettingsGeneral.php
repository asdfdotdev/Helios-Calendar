 ...
 */
	...
	$submit = cOut(Amysqlresult($result,0,0));
	$rssMax = cOut(Amysqlresult($result,1,0));
	$passApprove = cOut(Amysqlresult($result,2,0));
	$passDecline = cOut(Amysqlresult($result,3,0));
	$driving = cOut(Amysqlresult($result,4,0));
	$weather = cOut(Amysqlresult($result,5,0));
	$mostPopular = cOut(Amysqlresult($result,6,0));
	$browsePast = cOut(Amysqlresult($result,7,0));
	$maxShow = cOut(Amysqlresult($result,8,0));
	$fillMax = cOut(Amysqlresult($result,9,0));
	$dateFormat = cOut(Amysqlresult($result,10,0));
	$showTime = cOut(Amysqlresult($result,11,0));
	$state = cOut(Amysqlresult($result,12,0));
	$calStartDay = cOut(Amysqlresult($result,13,0));
	$timeFormat = cOut(Amysqlresult($result,14,0));
	$popDateFormat = cOut(Amysqlresult($result,15,0));
	$passAge = cOut(Amysqlresult($result,16,0));
	$langType = cOut(Amysqlresult($result,17,0));
	$userCat = cOut(Amysqlresult($result,18,0));
	$WYSIWYG = cOut(Amysqlresult($result,19,0));
	$timeInput = cOut(Amysqlresult($result,20,0));
	$captchas = explode(",", cOut(Amysqlresult($result,21,0)));
	$series = cOut(Amysqlresult($result,22,0));
	$browseType = cOut(Amysqlresult($result,23,0));
	$timezoneOffset = cOut(Amysqlresult($result,24,0));
	$subLimit = cOut(Amysqlresult($result,25,0));
	$stats = cOut(Amysqlresult($result,26,0));
	$float = cOut(Amysqlresult($result,27,0));
	$searchWindow = cOut(Amysqlresult($result,28,0)) + 1;
	$pubNews = cOut(Amysqlresult($result,29,0));
	$jssMax = cOut(Amysqlresult($result,30,0));
	$capType = cOut(Amysqlresult($result,31,0));
	$maxNew = cOut(Amysqlresult($result,32,0));
	$reCapPub = cOut(Amysqlresult($result,33,0));
	$reCapPriv = cOut(Amysqlresult($result,34,0));
	$locSelect = cOut(Amysqlresult($result,35,0));
	$mailMethod = cOut(Amysqlresult($result,36,0));
	$mailHost = cOut(Amysqlresult($result,37,0));
	$mailPort = cOut(Amysqlresult($result,38,0));
	$mailSecure = cOut(Amysqlresult($result,39,0));
	$mailUser = cOut(Amysqlresult($result,40,0));
	$mailPass = base64_decode(cOut(Amysqlresult($result,41,0)));
	$mailAuth = cOut(Amysqlresult($result,42,0));
	$mailAddress = cOut(Amysqlresult($result,43,0));
	$mailName = cOut(Amysqlresult($result,44,0));
	$loginTries = cOut(Amysqlresult($result,45,0));
	$batchSize = cOut(Amysqlresult($result,46,0));
	$batchDelay = cOut(Amysqlresult($result,47,0));
	$sitemap = cOut(Amysqlresult($result,48,0));
	$iCalMax = cOut(Amysqlresult($result,49,0));
	$iCalRef = cOut(Amysqlresult($result,50,0));
	$reCapStyle = cOut(Amysqlresult($result,51,0));
	$passStr = cOut(Amysqlresult($result,52,0));
	$mc_select = cOut(Amysqlresult($result,53,0));
	$mc_dow = cOut(Amysqlresult($result,54,0));
	$rssStatus = cOut(Amysqlresult($result,55,0));
	$rssTrunc = cOut(Amysqlresult($result,56,0));
	$iCalStatus = cOut(Amysqlresult($result,57,0));
	$iCalTrunc = cOut(Amysqlresult($result,58,0));
	$sendPast = cOut(Amysqlresult($result,59,0));
