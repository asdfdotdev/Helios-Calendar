...
*/
	...
	$result = doQuery("SELECT SettingValue FROM " . HC_TblPrefix . "settings WHERE PkID IN (1,2,3,4,8,9,10,11,12,13,14,15,21,22,23,24,25,28,29,30,31,32,33,34,35,40,44,53,56) ORDER BY PkID");
	...
	$recomnds = cOut(mysql_result($result,27,0));
	$useComments = cOut(mysql_result($result,28,0));
?>
