...
<?php 	$cnt = 0;
	...
	<?php 	if(!isset($_GET['mID'])){?>
			<div class="mostPopularTools<?php if($cnt % 2 == 1){echo "HL";}?>">
				<a href="<?php echo CalAdminRoot;?>/index.php?com=eventedit&amp;eID=<?php echo $row[0];?>" class="main"><img src="<?php echo CalAdminRoot;?>/images/icons/iconEdit.gif" width="15" height="15" alt="" border="0" align="middle" /></a>&nbsp;&nbsp;
		<?php 	if($row[18] == 1){	?>
				<a href="<?php echo CalAdminRoot;?>/index.php?com=eventbillboard" class="main"><img src="<?php echo CalAdminRoot;?>/images/icons/iconBillboard.gif" width="15" height="15" alt="" border="0" align="middle" /></a>
		<?php 	} else {	?>
				<img src="<?php echo CalAdminRoot;?>/images/spacer.gif" width="15" height="15" alt="" border="0" align="middle" />
		<?php 	}//end if	?>
			</div>
	<?php 	}//end if
		$cnt = $cnt + 1;
