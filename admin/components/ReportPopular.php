...
*/
	...
	if(!isset($_GET['mID'])){
		...
		appInstructions(0, "Most_Popular_Mobile_Events", "Most Popular Active Mobile Events", "The following events are the most viewed active events on the mobile calendar.<br /><br /><img src=\"" . CalAdminRoot . "/images/icons/iconEdit.gif\" width=\"15\" height=\"15\" alt=\"\" border=\"0\" align=\"middle\"> = Edit Event");
		$result = doQuery("	SELECT * 
								FROM " . HC_TblPrefix . "events 
							WHERE StartDate >= NOW() 
								AND IsActive = 1 
