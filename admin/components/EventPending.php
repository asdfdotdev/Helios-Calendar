		...
		<?php 	}//end if
				...
				if($row[3] != '' && $curSeries != $row[3]){
					...
					<div class="pendingList">
						...
						<div style="width: 73px;float:left;text-align:right;"><a href="<?php echo CalAdminRoot;?>/index.php?com=eventpending&amp;sID=<?php echo $row[3];?>" class="main"><img src="<?php echo CalAdminRoot;?>/images/icons/iconEditGroup.gif" width="15" height="15" alt="" border="0" align="absmiddle" /></a></div>
						&nbsp;
					</div>
		<?php 	}//end if	?>
					...
					<div class="pendingListTools<?php if($cnt % 2 == 1){echo "HL";}?>">&nbsp;<a href="<?php echo CalAdminRoot;?>/index.php?com=eventpending&amp;eID=<?php echo $row[0];?>" class="main"><img src="<?php echo CalAdminRoot;?>/images/icons/iconEdit.gif" width="15" height="15" alt="" border="0" align="absmiddle" /></a>
...
<?php 	if(hasRows($result)){
	...
	<?php 	}//end if	?>
		...
		<?php 	} else {	?>
					...
					<div class="frmOpt">
						<label>&nbsp;</label>
						<label for="newLoc" class="radioWide"><input name="newLoc" id="newLoc" type="checkbox" />Save as New Location</label>
					</div><br />
		<?php 	}//end if	?>
				<div class="frmReq">
