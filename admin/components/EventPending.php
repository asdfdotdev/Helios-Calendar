...
*/
	...
	if(!isset($_GET['sID']) && !isset($_GET['eID'])){
		...
		if(hasRows($result)){
			...
			<form name="eventPending" id="eventPending" method="post" action="<?echo CalAdminRoot?>/components/EventDelete.php" onsubmit="return chkFrm();">
		...
		<?	while($row = mysql_fetch_row($result)){
			...
			<?	}//end if	?>
					...
					<div class="pendingListTools<?if($cnt % 2 == 1){echo "HL";}?>">&nbsp;<a href="<?echo CalAdminRoot;?>/index.php?com=eventpending&amp;eID=<?echo $row[0];?>" class="main"><img src="<?echo CalAdminRoot;?>/images/icons/iconEdit.gif" width="15" height="15" alt="" border="0" align="middle" /></a>
