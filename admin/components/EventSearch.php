...
<?php
	if($sID > 0){
		appInstructions(0, "Event Report Search", "Please use the form below to search the events for which you wish to generate a report.");
	} else {
		...
		appInstructions(0, "Event Edit Search", "Please use the form below to search for the event(s) you wish to edit.");
	}//end if
?>
