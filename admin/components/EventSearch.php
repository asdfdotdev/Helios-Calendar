 ...
 */
	...
	$region = ($hc_lang_config['AddressRegion'] != 0) ? ' | <a href="javascript:;" onclick="toggleMe(2)" class="legend">'.$hc_lang_config['RegionTitle'] . '</a>' : '';
	...
	<fieldset>
		<legend>
			<a href="javascript:;" onclick="toggleMe(0);" class="legend">' . $hc_lang_search['LinkLocation'] . '</a>
			| <a href="javascript:;" onclick="toggleMe(1);" class="legend">' . $hc_lang_search['LinkCity'] . '</a>
			'.$region.'
			| <a href="javascript:;" onclick="toggleMe(3)" class="legend">' . $hc_lang_search['LinkPostal'] . '</a>
		</legend>
		<div id="location_div">';
	...
	function validate(){
		...
		//err += validGreater(document.getElementById("keyword"),3,"'.$hc_lang_search['Valid19'].'\n");
