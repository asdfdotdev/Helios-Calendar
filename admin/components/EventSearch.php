...
<?php
	...
	<fieldset>
		<legend>
	<?php
		echo '<a href="javascript:;" onclick="toggleMe(\'location\',\'city\',\'locState\',\'postal\');" class="main">' . $hc_lang_search['LinkLocation'] . '</a>';
		echo ' | <a href="javascript:;" onclick="toggleMe(\'city\',\'location\',\'locState\',\'postal\');" class="main">' . $hc_lang_search['LinkCity'] . '</a>';
		echo ($hc_lang_config['AddressRegion'] != 0) ? ' | <a href="javascript:;" onclick="toggleMe(\'locState\',\'city\',\'postal\',\'location\')" class="main">' . $hc_lang_config['RegionTitle'] . '</a>' : '';
		echo ' | <a href="javascript:;" onclick="toggleMe(\'postal\',\'city\',\'locState\',\'location\')" class="main">' . $hc_lang_search['LinkPostal'] . '</a>';
		?>
		</legend>
		<div id="locationdiv">
