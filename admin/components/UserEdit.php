...
<?	if (isset($_GET['msg'])){
	...
	<form name="frmUserEdit" id="frmUserEdit" method="post" action="<?echo CalAdminRoot . "/components/UserEditAction.php";?>" onsubmit="return chkFrm();">
	...
	<?	}//end if	?>
		...
		<?	include('../events/includes/selectOccupation.php');?>
		</div>
		<div class="frmUserEditReq">
