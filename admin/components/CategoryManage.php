...
*/
	...
	function doDelete(dID){
		if(confirm('Are you sure you want to delete the category?\n\n          Ok = YES Delete Category\n          Cancel = NO Don\'t Delete Category')){
			window.location.href='<?echo CalAdminRoot . "/" . HC_CategoryManageAction;?>?dID=' + dID;
		}//end if
	}//end doDelete
...
<?	if (isset($_GET['msg'])){
	...
	<form name="frm" id="frm" method="post" action="<?echo CalAdminRoot . "/" . HC_CategoryManageAction;?>" onsubmit="return chkFrm();">
