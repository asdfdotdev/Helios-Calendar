 ...
 */
	...
	$oldEmail = $firstname = $lastname = $email = '';
	$editEvent = $eventPending = $eventCategory = $userEdit = $adminEdit = $newsletter = $settings = $tools = $reports = $locEdit = $comments = 0;
	$notices = array();
...
<?php 	} else {
			echo '<div class="frmOpt">' . $hc_lang_admin['NoEdit'] . '</div>';
		}//end if	?>
	</fieldset>
	<br />
