...
*/
	...
	if(hasRows($result)){
		...
		$comments = cOut(mysql_result($result,0,22));
	} else {
		$uID = 0;
...
<?php 	}//end if	?>
	...
	<fieldset>
		...
		<div class="frmOpt">
			...
			<input name="notices[]" id="noteEmail" type="checkbox" value="0" <?php if(in_array(0, $notices)){echo 'checked="checked"';}?> />
		...
		<div class="frmOpt">
			...
			<input name="notices[]" id="noteComment" type="checkbox" value="1" <?php if(in_array(1, $notices)){echo 'checked="checked"';}?> />
