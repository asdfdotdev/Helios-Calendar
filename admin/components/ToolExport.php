...
*/
	...
	<fieldset>
		...
		<div class="frmReq">
			...
			&nbsp;<a href="javascript:;" onclick="calx.select(document.frmEventExport.startDate,'anchor1','<?php echo $hc_popDateValid;?>'); return false;" name="anchor1" id="anchor1"><img src="<?php echo CalAdminRoot;?>/images/icons/iconCalendar.gif" width="16" height="16" border="0" alt="" align="middle" /></a>&nbsp;
			&nbsp;to&nbsp;&nbsp;
			<input size="12" maxlength="10" type="text" name="endDate" id="endDate" value="<?php echo date($hc_popDateFormat, mktime(0, 0, 0, date("m"), date("d") + 7, date("Y")));?>" class="input">
			&nbsp;<a href="javascript:;" onclick="calx.select(document.frmEventExport.endDate,'anchor2','<?php echo $hc_popDateValid;?>'); return false;" name="anchor2" id="anchor2"><img src="<?php echo CalAdminRoot;?>/images/icons/iconCalendar.gif" width="16" height="16" border="0" alt="" align="middle" /></a>
		</div>
	</fieldset>
	<br />
	<fieldset>
