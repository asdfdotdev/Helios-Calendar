...
<?php 	$cnt = 0;
		...
		while($row = mysql_fetch_row($result)){	?>
			...
			<div class="recentTools<?php if($cnt % 2 == 1){echo "HL";}?>">
				<a href="<?php echo CalAdminRoot;?>/index.php?com=eventedit&amp;eID=<?php echo $row[0];?>" class="main"><img src="<?php echo CalAdminRoot;?>/images/icons/iconEdit.gif" width="15" height="15" alt="" border="0" /></a>&nbsp;&nbsp;
		<?php 	if($row[18] == 1){	?>
					<a href="<?php echo CalAdminRoot;?>/index.php?com=eventbillboard" class="main"><img src="<?php echo CalAdminRoot;?>/images/icons/iconBillboard.gif" width="15" height="15" alt="" border="0" /></a>
		<?php 	} else {	?>
