 ...
 */
	...
	if($nID > 0){
		...
		if(mysql_result($result,0,2) == 0){
			...
			echo '<div class="progBar" style="background-image: url(../img/progress/go.png);background-position:-500 0;">&nbsp;&nbsp;' . $hc_lang_news['Status0'] . '</div>';
		} else if($prog < 100){
			if(mysql_result($result,0,2) == 2) {
				echo '<div class="progBar" style="background-image: url(../img/progress/pause.png);background-position:'.$position.' 0;">&nbsp;&nbsp;' . $hc_lang_news['Status2'] . ' (' . abs(number_format($prog,0)) . '%)</div>';
			} else {
			...
			<div class="progBar" style="background-image: url(../img/progress/go.png);background-position:'.$position.' 0;">&nbsp;&nbsp;'.abs(number_format($prog,0)).'% '.$hc_lang_news['Complete'].'</div>';
				} else {
			...
			echo '
			<div class="progBar" style="background-image: url(../img/progress/go.png);background-position:'.$position.' 0;">&nbsp;&nbsp;100% '.$hc_lang_news['Complete'].'</div>
	...
	function buildPersonal($template,$start,$end,$categories,$fname,$lname,$email,$postal,$format){
		...
		$formatLink = '';
		if($format < 2)
			$formLink = ($format == 1) ? '&theme='.$hc_cfg[84] : '&theme='.$hc_cfg[83];
	...
	function stopError($errMsg){
		global $hc_lang_news;
		echo '<div class="progBar" style="background-image: url(../img/progress/go.png);background-position:-500 0;color:#DC143C;">&nbsp;&nbsp;' . $hc_lang_news['Error'] . ' ' . $errMsg . '</div>';
		exit();
	}
?>