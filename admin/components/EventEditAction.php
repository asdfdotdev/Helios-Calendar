 ...
 */
	...
	$locID = ($_POST['locPreset'] == '') ? '0' : $_POST['locPreset'];
	$cost = $_POST['cost'];
	...
	if(!isset($_POST['editString'])){
		...
		$query .= ", StartDate = '" . cIn($eventDate) . "'
							 WHERE PkID = '" . $eID . "' ";
		$eventIDs = array($eID);
		$hdrStr = CalAdminRoot . "/index.php?com=eventedit&eID=" . $eID  . "&msg=" . $msgID;
	} else {
		$msgID = 2;
		...
		$hdrStr = CalAdminRoot . "/index.php?com=eventsearch&sID=1&msg=" . $msgID;
	}//end if
