					...
					<td class="eventMain" colspan="3" valign="top">
						...
						<div class="panel" id="credits">
							...
							<table cellspacing="1" cellpadding="1" border="0" style="padding-left: 10px;">
								...
								<tr>
									<td class="eventMain"><a href="http://wurfl.sourceforge.net/" class="main" target="_blank">Andrea Trasatti</a>&nbsp;&nbsp;</td>
									<td class="eventMain">WURFL</td>
								</tr>
								<tr><td colspan="2"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="4" alt="" border="0"></td></tr>
								<tr>
								...
								<tr><td colspan="2"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="4" alt="" border="0"></td></tr>
								<tr>
									<td class="eventMain"><a href="http://www.rjk-hosting.co.uk/programs/prog.php?id=7" class="main" target="_blank">Richard James Kendall</a></td>
									<td class="eventMain">PHP RSS Reader</td>
								</tr>
							</table>
						...
						<div class="panel" id="registration" style="display: none">
							...
							<?	$result = doQuery("SELECT SettingValue FROM " . HC_TblPrefix . "settings WHERE PkID IN(16,17,18,19) ORDER BY PkID");	?>
								<tr>
									...
									<td class="eventMain"><?echo mysql_result($result,0,0);?></td>
								</tr>
								<tr>
									<td width="120" class="eventMain">Registered Domain</td>
									<td class="eventMain"><?echo mysql_result($result,1,0);?></td>
								</tr>
								<tr>
									<td width="120" class="eventMain">Email Address</td>
									<td class="eventMain"><?echo mysql_result($result,2,0);?></td>
								</tr>
								<tr>
									<td width="120" class="eventMain">Registration Code</td>
									<td class="eventMain"><?echo mysql_result($result,3,0);?></td>
								</tr>
							<table>
