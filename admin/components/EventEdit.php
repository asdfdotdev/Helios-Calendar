...
*/
	...
	function togOverride(){
		if(document.frmEventEdit.overridetime.checked == true){
	...
	function togEndTime(){
		if(document.frmEventEdit.ignoreendtime.checked == true){
			document.frmEventEdit.endTimeHour.disabled = true;
			document.frmEventEdit.endTimeMins.disabled = true;
			document.frmEventEdit.endTimeAMPM.disabled = true;
		} else {
...
<?	if(!isset($eventID)){
	...
	<form id="frmEventEdit" name="frmEventEdit" method="post" action="<?echo CalAdminRoot . "/" . HC_EventEditAction;?>" onsubmit="return chkFrm();">
...
<?	if(isset($editString)){	?>
	<input type="hidden" name="editString" id="editString" value="<?echo $editString;?>" />	<?
		...
		?>
		<br />
		<label for="makeseries"><input type="checkbox" name="makeseries" id="makeseries">Combine Events to New Series</label>
		<br />
<?		}//end if
	}//end if	?>
	...
	<fieldset>
		...
		<div class="frmOpt">
			...
			<table cellpadding="1" cellspacing="0" border="0">
				<tr>
					<td><input name="startTimeHour" id="startTimeHour" type="text" value="<?echo $startTimeHour;?>" size="2" maxlength="2" /></td>
					...
					<td><input name="startTimeMins" id="startTimeMins" type="text" value="<?echo $startTimeMins;?>" size="2" maxlength="2" /></td>
	...
	<fieldset>
		...
		<div class="frmOpt">
			...
			<input name="locName" id="locName" value="<?echo $locName;?>" type="text" maxlength="50" size="40" /><span style="color: #DC143C">*</span>
		</div>
		<div class="frmOpt">
			<label for="locAddress">Address:</label>
			<input name="locAddress" id="locAddress" value="<?echo $locAddress;?>" type="text" maxlength="75" size="30" /><span style="color: #0000FF">*</span>
		</div>
		<div class="frmOpt">
			<label for="locAddress2">&nbsp;</label>
			<input name="locAddress2" id="locAddress2" value="<?echo $locAddress2;?>" type="text" maxlength="75" size="25" />
		</div>
		<div class="frmOpt">
			<label for="locCity">City:</label>
			<input name="locCity" id="locCity" value="<?echo $locCity;?>" type="text" maxlength="50" size="20" /><span style="color: #0000FF">*</span>
		</div>
		<div class="frmOpt">
		...
		<div class="frmOpt">
			...
			<input name="locZip" id="locZip" value="<?echo $locZip;?>" type="text" maxlength="11" size="11" /><span style="color: #0000FF">*</span>
		</div>
	</fieldset>
	<br />
	<fieldset>
		...
		<div class="frmOpt">
			...
			<input name="contactPhone" id="contactPhone" type="text" value="<?echo $contactPhone;?>" maxlength="15" size="15" />
		</div>
		<div class="frmOpt">
