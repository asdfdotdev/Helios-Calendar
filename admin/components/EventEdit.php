...
<?	} else {
	...
	warn = "Event could not be updated for the following reason(s):";
		...
		} else if((document.frmEventEdit.startTimeHour.value > <?echo $hc_timeInput;?>) || (document.frmEventEdit.startTimeHour.value < <?echo $minHr;?>)) {
			dirty = 1;
		...
		} else if((document.frmEventEdit.endTimeHour.value > <?echo $hc_timeInput;?>) || (document.frmEventEdit.endTimeHour.value < <?echo $minHr;?>)) {
			dirty = 1;
...
<?		}//end if
	...
	<fieldset>
		...
		<div class="frmOpt">
			...
			<?makeTinyMCE("eventDescription", $hc_WYSIWYG, "435px", "advanced", $eventDesc);?>
		</div>
		<?if(!isset($editString)){	?>
		<div class="frmReq">
		...
		<div class="frmOpt">
			...
			<table cellpadding="1" cellspacing="0" border="0">
				<tr>
					...
					<td><a href="javascript:;" onclick="chngClock(document.frmEventEdit.startTimeHour,1,<?echo $hc_timeInput;?>)"><img src="<?echo CalAdminRoot;?>/images/time_up.gif" width="16" height="8" alt="" border="0" /></a><br /><a href="javascript:;" onclick="chngClock(document.frmEventEdit.startTimeHour,-1,<?echo $hc_timeInput;?>)"><img src="<?echo CalAdminRoot;?>/images/time_down.gif" width="16" height="9" alt="" border="0" /></a></td>
		...
		<div class="frmOpt">
			...
			<table cellpadding="1" cellspacing="0" border="0">
				<tr>
					...
					<td><a href="javascript:;" onclick="chngClock(document.frmEventEdit.endTimeHour,1,<?echo $hc_timeInput;?>)"><img src="<?echo CalAdminRoot;?>/images/time_up.gif" width="16" height="8" alt="" border="0" /></a><br /><a href="javascript:;" onclick="chngClock(document.frmEventEdit.endTimeHour,-1,<?echo $hc_timeInput;?>)"><img src="<?echo CalAdminRoot;?>/images/time_down.gif" width="16" height="9" alt="" border="0" /></a></td>
		...
		<div class="frmOpt">
			...
			<input name="cost" id="cost" type="text" value="<?echo $cost;?>" size="15" maxlength="18" />
		</div>
	</fieldset>
	<br />
	<fieldset>
	...
	<?	}//end if	?>
		...
		<div class="frmOpt">
			...
			<input <?if($locID > 0){echo "disabled=\"disabled\"";}?> name="locCountry" id="locCountry" value="<?echo $locCountry;?>" type="text" maxlength="50" size="5" />
		</div>
	</fieldset>
	<br />
	<fieldset>
