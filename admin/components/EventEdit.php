...
<?php
	...
	&nbsp; <span style="line-height: 23px;"><b>Copy Event Using Live Clipboard</b></span><br /><br />
...
<?php
	...
	var calObj = new HCal("<?php echo $liveClipLink;?>", "<?php echo cleanXMLChars($eventTitle);?>", "<?php echo cleanXMLChars($eventDesc);?>", "<?php echo $startDate;?>", "<?php echo $endDate;?>", "<?php echo stampToDate(cOut(mysql_result($result,0,9)), $hc_dateFormat) . ", " . $eventStartTime;?>", "<?php echo $locID;?>", "", "", "<?php echo date("Ymd\THis");?>", "<?php echo $eventEndTime;?>");   
			...
			<?php 	}//end if	?>
					<tr>
						...
						<td class="<?php if($cnt % 2 == 0){echo "main";}else{echo"tblListHL";}?>" align="center">
							<a href="<?php echo CalAdminRoot;?>/index.php?com=eventregister&amp;rID=<?php echo $row[0];?>&amp;eID=<?php echo $eID;?>" class="main"><img src="<?php echo CalAdminRoot;?>/images/icons/iconEdit.gif" width="15" height="15" alt="" border="0" align="absmiddle" /></a>&nbsp;
							<a href="javascript:;" onclick="delReg(<?php echo $row[0];?>);return false;" class="main"><img src="<?php echo CalAdminRoot;?>/images/icons/iconDelete.gif" width="15" height="15" alt="" border="0" align="absmiddle" /></a></td>
					</tr>
			<?php 	$cnt++;
				}//end while	?>
			</table>
