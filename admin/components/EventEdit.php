...
<?php 	}//end if	?>
		...
		if(compareDates(document.frmEventEdit.eventDate.value, '<?php echo $hc_popDateValid;?>', '<?php echo date($hc_popDateFormat, mktime(0, 0, 0, date("m"), date("d") - 1, date("Y")) );?>', '<?php echo $hc_popDateValid;?>') == 0){
...
<?php 	}//end if
	...
	<fieldset>
		...
		<div class="frmReq">
			...
			<input name="eventTitle" id="eventTitle" type="text" maxlength="150" style="width:75%;" value="<?php if(isset($eventTitle)){echo $eventTitle;}//end if?>" />&nbsp;<span style="color: #DC143C">*</span>
		</div>
		<div class="frmOpt">
