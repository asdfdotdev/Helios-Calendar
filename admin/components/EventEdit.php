 ...
 */
	...
	$result = doQuery("SELECT e.*, l.PkID, l.Name, l.Address, l.Address2, l.City, l.State, l.Zip, l.Country, f.EntityID, f.Note, u.NetworkName, u.Email
	...
	if(!hasRows($result) || $eID < 1 || mysql_result($result,0,0) < 1){
		...
		$fnote = cOut(mysql_result($result,0,50));
