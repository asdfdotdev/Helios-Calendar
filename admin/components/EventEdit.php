			...
			<td class="eventMain">
				...
				<?php
					$query = "	SELECT " . HC_TblPrefix . "categories.*, 1 as IsSelected
								...
								WHERE " . HC_TblPrefix . "categories.IsActive = 1 AND " . HC_TblPrefix . "eventcategories.EventID = " . cIn($eID) . "
								UNION
								SELECT " . HC_TblPrefix . "categories.*, 0 as IsSelected
								FROM " . HC_TblPrefix . "categories
									LEFT JOIN " . HC_TblPrefix . "eventcategories ON (" . HC_TblPrefix . "categories.PkID = " . HC_TblPrefix . "eventcategories.CategoryID)
								WHERE " . HC_TblPrefix . "categories.IsActive = 1 AND " . HC_TblPrefix . "eventcategories.EventID != " . cIn($eID) . " OR " . HC_TblPrefix . "eventcategories.EventID is null
