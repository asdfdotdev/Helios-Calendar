 ...
 */
	...
	if($fp = fsockopen($ip, 80, $errno, $errstr, 1)){
		...
		<fieldset>
			<legend>
				'.$hc_lang_home['Update'].'
				<a class="tooltip" data-tip="Helios Calendar News & Announcements (Refresh Community Forum)" href="https://www.refreshmy.com/news/r/" target="_blank" tabindex="-1"><img src="'.AdminRoot.'/img/logos/refresh_icon.png" width="16" height="16" alt="" /></a>
				<a class="tooltip" data-tip="Helios Calendar Updates on Facebook" href="https://www.refreshmy.com/news/f/" target="_blank" tabindex="-1"><img src="'.AdminRoot.'/img/logos/facebook_icon.png" width="16" height="16" alt="" /></a>
				<a class="tooltip" data-tip="Helios Calendar Updates on Twitter" href="https://www.refreshmy.com/news/t/" target="_blank" tabindex="-1"><img src="'.AdminRoot.'/img/logos/twitter_icon.png" width="16" height="16" alt="" /></a>
				<a class="tooltip" data-tip="Helios Calendar Updates on Google+" href="https://www.refreshmy.com/news/g/" target="_blank" tabindex="-1"><img src="'.AdminRoot.'/img/logos/gplus_icon.png" width="16" height="16" alt="" /></a>
			</legend>
