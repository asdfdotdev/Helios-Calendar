...
*/
	...
	if(isset($_GET['nID']) && is_numeric($_GET['nID'])){
		...
		<form name="frm" id="frm" method="post" action="<?echo CalAdminRoot . "/components/NewsletterEditAction.php";?>" onsubmit="return chkFrm();">
...
<?	} else {
	...
	function doDelete(dID){
		if(confirm('Template Delete Is Permanent!\nAre you sure you want to delete the template?\n\n          Ok = YES Delete Template\n          Cancel = NO Don\'t Delete Template')){
			document.location.href = '<?echo CalAdminRoot . "/components/NewsletterEditAction.php";?>?dID=' + dID;
		}//end if
	}//end doDelete
