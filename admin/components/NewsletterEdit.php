	...
	if(hasRows($result)){
			...
			?>
				<tr>
					...
					<td class="eventMain" <?if($cnt % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?> width="20"><a href="<?echo CalAdminRoot;?>/index.php?com=newsletteredit&nID=<?echo cOut($row[0]);?>" class="main" title="Edit Template"><img src="<?echo CalAdminRoot;?>/images/iconEdit.gif" width="15" height="15" alt="" border="0" title="Edit Template"></a></td>
					<td class="eventMain" <?if($cnt % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?>><a href="javascript:doDelete('<?echo cOut($row[0]);?>');" class="main" title="Delete Template"><img src="<?echo CalAdminRoot;?>/images/iconDelete.gif" width="15" height="15" alt="" border="0" title="Delete Template"></a></td>
				</tr>
