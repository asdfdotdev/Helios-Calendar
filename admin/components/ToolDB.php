 ...
 */
	...
	if($doOpt == 1){
		$result = doQuery("OPTIMIZE TABLE `".HC_TblPrefix."admin`,
						...
						`".HC_TblPrefix."eventcategories`,`".HC_TblPrefix."eventnetwork`,`".HC_TblPrefix."events`,`".HC_TblPrefix."followup`,`".HC_TblPrefix."locationnetwork`,
						`".HC_TblPrefix."locations`,`".HC_TblPrefix."mailers`,`".HC_TblPrefix."mailersgroups`,`".HC_TblPrefix."mailgroups`,`".HC_TblPrefix."newsletters`,
						`".HC_TblPrefix."newssubscribers`,`".HC_TblPrefix."registrants`,`".HC_TblPrefix."sendtofriend`,`".HC_TblPrefix."settings`,`".HC_TblPrefix."settingsmeta`,
						`".HC_TblPrefix."subscribers`,`".HC_TblPrefix."subscriberscategories`,`".HC_TblPrefix."subscribersgroups`,`".HC_TblPrefix."templates`,`".HC_TblPrefix."templatesnews`");
		if(hasRows($result)){
	...
	$result = doQuery("SHOW TABLE STATUS
					...
					'".HC_TblPrefix."adminloginhistory','".HC_TblPrefix."adminnotices','".HC_TblPrefix."adminpermissions','".HC_TblPrefix."categories',
					'".HC_TblPrefix."eventcategories','".HC_TblPrefix."eventnetwork','".HC_TblPrefix."events','".HC_TblPrefix."followup','".HC_TblPrefix."locationnetwork','".HC_TblPrefix."locations',
					'".HC_TblPrefix."mailers','".HC_TblPrefix."mailersgroups','".HC_TblPrefix."mailgroups','".HC_TblPrefix."newsletters','".HC_TblPrefix."newssubscribers',
					'".HC_TblPrefix."registrants','".HC_TblPrefix."sendtofriend','".HC_TblPrefix."settings','".HC_TblPrefix."settingsmeta','".HC_TblPrefix."subscribers',
					'".HC_TblPrefix."subscriberscategories','".HC_TblPrefix."subscribersgroups','".HC_TblPrefix."templates','".HC_TblPrefix."templatesnews')");
	echo '
	<ul class="data">
