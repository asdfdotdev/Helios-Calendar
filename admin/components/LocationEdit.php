...
*/
	...
	<?php 	}//end if	?>
		...
		<?php
			if($lat != '' && $lon != ''){
				echo '<a href="' . $hc_cfg52 . '/maps?q=' . $lat . ',' . $lon . '" target="_blank" title="' . $hc_lang_locations['Preview'] . '"><img src="' . CalRoot . '/images/share/google.png" width="16" height="16" alt="' . $hc_lang_locations['Preview'] . '" border="0" style="vertical-align:middle;" /></a>';
			}//end if?>
		</div>
		<div class="frmOpt">
			<label>&nbsp;</label>
