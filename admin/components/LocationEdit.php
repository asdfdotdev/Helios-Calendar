 ...
 */
	...
	$name = $address = $address2 = $city = $country = $postal = $phone = $email = $descript = $lat = $lon = $geoAccuracy = $shortURL = $website = '';
	$state = $hc_cfg[21];
	$status = 1;
	...
	<fieldset>
		...
		<p>
			'.(($efID != '' || $ebID != '') ? '<b>'.$hc_lang_locations['PostedTo'].'</b>' : '').'
		...
		<p><i>' . $hc_lang_locations['DistPubNotice'] . '</i></p>
