...
*/
	...
	appInstructions(0, "Recently Added Events", "The following are the fifty newest events added to " . CalName . ".<br><br><table cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td><img src=\"" . CalAdminRoot . "/images/iconEdit.gif\" width=\"15\" height=\"15\" alt=\"\" border=\"0\"></td><td class=\"eventMain\">&nbsp;= Edit Event</td></tr></table>");
		...
		<?
			...
			while($row = mysql_fetch_row($result)){	?>
				<tr>
					...
					<td class="eventMain" <?if($cnt % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?>>
						<?echo stampToDate($row[27], "m/d/Y")?>
					</td>
					<td class="eventMain" <?if($cnt % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?>>
						<?echo stampToDate($row[9], "m/d/Y")?>
					</td>
