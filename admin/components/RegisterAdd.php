...
?>
	...
	<form id="frm" name="frm" method="post" action="<?echo CalAdminRoot . "/" . HC_RegisterAdd;?>" onsubmit="return chkFrm();">
	...
	<fieldset>
		...
		<div class="frmOpt">
			...
			<input name="phone" id="phone" type="text" size="15" maxlength="15" value="<?echo $phone;?>" />
		</div>
		<div class="frmOpt">
	...
	<input name="cancel" id="cancel" type="button" value="   Cancel   " onclick="window.location.href='http://lakota/helios/admin/index.php?com=eventedit&amp;eID=<?echo $_GET['eID'];?>';" class="button" />
	</form>
	</div>