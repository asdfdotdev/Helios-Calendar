...
?>
	...
	<input name="cancel" id="cancel" type="button" value="   Cancel   " onclick="window.location.href='<?php echo CalAdminRoot;?>/index.php?com=eventedit&amp;eID=<?php echo $_GET['eID'];?>';" class="button" />
	</form>
	</div>