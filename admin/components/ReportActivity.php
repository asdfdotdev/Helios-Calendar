...
<?php
		...
		include($hc_langPath . $_SESSION[$hc_cfg00 . 'LangSet'] . '/admin/reports.php');
		echo '<div align="right"><img src="' . CalAdminRoot . '/images/icons/iconPrint.png" width="15" height="15" alt="" border="0" style="vertical-align:middle;" /> <a href="' . CalAdminRoot . '/components/ReportActivity.php?print=1&amp;eID=' . urlencode($eID) . '" class="main" target="_blank">' . $hc_lang_reports['Print'] . '</a></div>';
	}//end if
	...
	if(hasRows($result)){
		...
		$resultC = doQuery("SELECT COUNT(EntityID) as NUM
                              ...
                              ORDER BY Num DESC
                              LIMIT 1");
          $maxComment = cOut(mysql_result($resultC,0,0));
          $cnt = 0;
