...
*/
	...
	if(hasRows($result)){
		if(!isset($print)){	?>
			<div align="right"><img src="<?php echo CalAdminRoot;?>/images/icons/iconPrint.gif" width="15" height="15" alt="" border="0" align="absmiddle" /> <a href="<?php echo CalAdminRoot;?>/components/ReportActivity.php?eID=<?php echo urlencode($eID);?>" class="main" target="_blank">Printer Friendly</a></div>
<?php 	} else {	?>
			<!DOCTYPE html
