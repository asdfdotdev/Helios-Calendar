...
*/
	...
	if(hasRows($result)){
		if(!isset($print)){	?>
			<div align="right"><img src="<?echo CalAdminRoot;?>/images/icons/iconPrint.gif" width="15" height="15" alt="" border="0" align="middle" /> <a href="<?echo CalAdminRoot;?>/components/ReportActivity.php?eID=<?echo urlencode($eID);?>" class="main" target="_blank">Printer Friendly</a></div>
	<?	} else {	?>
			<!DOCTYPE html
			...
			<body>
			<span class="main"><b><?echo CalName;?> Event Report -- Powered by Helios <?echo HC_Version;?></b></span>
						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								<td colspan="2" class="eventMain">
									...
									<table cellpadding="0" cellspacing="0" border="0" width="100%">
										<tr>
											<td class="eventMain" colspan="2"><b><?echo $row[1];?></b></td>
										...
										<tr>
											...
											<td class="eventMain"><img src="<?echo CalAdminRoot;?>/images/meter/meterEnds.gif" width="1" height="10" alt="" border="0" /><img src="<?echo CalAdminRoot;?>/images/meter/meterBlue.gif" width="<?echo $meterMobileViews;?>" height="10" alt="" border="0" /><img src="<?echo CalAdminRoot;?>/images/meter/meterLGray.gif" width="<?echo $meterMobileViewsFill?>" height="10" alt="" border="0" /><img src="<?echo CalAdminRoot;?>/images/meter/meterEnds.gif" width="1" height="10" alt="" border="0" /></td>
										...
										<tr>
											...
											<td class="eventMain"><img src="<?echo CalAdminRoot;?>/images/meter/meterEnds.gif" width="1" height="10" alt="" border="0" /><img src="<?echo CalAdminRoot;?>/images/meter/meterYellow.gif" width="<?echo $meterDirections;?>" height="10" alt="" border="0" /><img src="<?echo CalAdminRoot;?>/images/meter/meterLGray.gif" width="<?echo $meterDirectionsFill?>" height="10" alt="" border="0" /><img src="<?echo CalAdminRoot;?>/images/meter/meterEnds.gif" width="1" height="10" alt="" border="0" /></td>
										...
										<tr>
											...
											<td class="eventMain"><img src="<?echo CalAdminRoot;?>/images/meter/meterEnds.gif" width="1" height="10" alt="" border="0" /><img src="<?echo CalAdminRoot;?>/images/meter/meterPurple.gif" width="<?echo $meterDownloads;?>" height="10" alt="" border="0" /><img src="<?echo CalAdminRoot;?>/images/meter/meterLGray.gif" width="<?echo $meterDownloadsFill?>" height="10" alt="" border="0" /><img src="<?echo CalAdminRoot;?>/images/meter/meterEnds.gif" width="1" height="10" alt="" border="0" /></td>
										...
										<tr>
											...
											<td class="eventMain"><img src="<?echo CalAdminRoot;?>/images/meter/meterEnds.gif" width="1" height="10" alt="" border="0" /><img src="<?echo CalAdminRoot;?>/images/meter/meterDGray.gif" width="<?echo $meterURL;?>" height="10" alt="" border="0" /><img src="<?echo CalAdminRoot;?>/images/meter/meterLGray.gif" width="<?echo $meterURLFill?>" height="10" alt="" border="0" /><img src="<?echo CalAdminRoot;?>/images/meter/meterEnds.gif" width="1" height="10" alt="" border="0" /></td>
