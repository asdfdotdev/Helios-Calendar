...
if($row_cnt > 0){
	...
	<?php
		appInstructions(0, "Orphan Events", "<img src=\"" . CalAdminRoot . "/images/iconEdit.gif\" width=\"15\" height=\"15\" alt=\"\" border=\"0\"> = Edit Event (Assign Categories)<br><img src=\"" . CalAdminRoot . "/images/iconDelete.gif\" width=\"15\" height=\"15\" alt=\"\" border=\"0\"> = Delete Event From Calendar");
	?>
	...
	<?php
		...
		?>
			<tr>
				<td class="eventMain" <?if($cnt % 2 == 0){echo "bgcolor=\"#EEEEEE\"";}//end if?>>&nbsp;<a href="<?echo CalAdminRoot;?>/index.php?com=eventedit&eID=<?echo $row[0];?>&oID=1" class="main"><?echo $row[1];?></a></td>
