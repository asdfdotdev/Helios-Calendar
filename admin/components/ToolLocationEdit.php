...
*/
	...
	<fieldset>
		...
		<div class="frmOpt">
			...
			Latitude:&nbsp;<input name="lat" id="lat" type="text" value="<?echo $lat;?>" size="10" maxlength="25" />&nbsp;&nbsp;Longtitude:&nbsp;<input name="lon" id="lon" type="text" value="<?echo $lon;?>" size="10" maxlength="25" />
		</div>
		<div class="frmOpt">
			<label>&nbsp;</label>
			<a href="http://www.google.com/search?q=free+geocoding&start=0&ie=utf-8&oe=utf-8&client=firefox-a&rls=org.mozilla:en-US:official" class="main" target="_blank">Manual Geocode Lookup</a>
			<br /><br />
		</div>
		<div class="frmOpt">
