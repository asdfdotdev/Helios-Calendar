...
if($row_cnt > 0){
	...
	<?php
		appInstructions(0, "Billboard Events", "<img src=\"" . CalAdminRoot . "/images/iconEdit.gif\" width=\"15\" height=\"15\" alt=\"\" border=\"0\"> = Edit Event<br><img src=\"" . CalAdminRoot . "/images/iconDelete.gif\" width=\"15\" height=\"15\" alt=\"\" border=\"0\"> = Remove Event From Billboard");
	?>
	...
	<?php
		...
		?>
			<tr>
				<td class="eventMain" <?if($cnt % 2 == 0){echo "bgcolor=\"#EEEEEE\"";}//end if?>>&nbsp;<a href="<?echo CalAdminRoot;?>/index.php?com=eventedit&eID=<?echo $row[0];?>" class="main"><?echo $row[1];?></a></td>
				...
				<td class="eventMain" <?if($cnt % 2 == 0){echo "bgcolor=\"#EEEEEE\"";}//end if?> align="right"><?echo $row[28];?>&nbsp;&nbsp;&nbsp;</td>
