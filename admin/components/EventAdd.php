	...
	warn = "Event could not be added for the following reason(s):";
		...
		if(document.frmEventAdd.recurCheck.checked){
			if(!isDate(document.frmEventAdd.recurEndDate.value, '<?echo $hc_popDateValid;?>')){
				dirty = 1;
				warn = warn + '\n*Recur End Date Format is Invalid Date or Format. Required Format: <?echo strtolower($hc_popDateValid);?>';
				...
				<tr>
					...
					<td style="vertical-align: top;">
						...
						<div class="recPanel" id="monthly" style="display: none;">
							<input name="monthlyOption" id="monthlyOption" type="radio" checked="checked" value="Day" class="noBorderIE" />Day&nbsp;<input name="monthlyDays" id="monthlyDays" type="text" maxlength="3" size="3" value="<?echo date("d");?>" />&nbsp;of every&nbsp;<input name="monthlyMonths" id="monthlyMonths" type="text" maxlength="2" size="2" value="1" />&nbsp;month(s)<br />
							<input name="monthlyOption" id="monthlyOption" type="radio" value="Month" class="noBorderIE" />
