 ...
 */
	...
	$startTimeHour = date($hrFormat, mktime(date($hourOffset), 0, 0, 1, 1, 1971));
...
<?php 	}//end if	?>
	...
	<?php
		...
		echo '<div id="twitter" style="display:none;clear:both;padding:7px 5px 0px 5px;">';
		echo '<input name="tweetThis" id="tweetThis" type="text" size="45" maxlength="104" value="" style="width:75%;" />';
		echo '<p style="clear:both;padding-top:10px;">' . $hc_lang_event['TwitterNotice'] . '</p>';
		echo '</div>';
		...
		echo ($goBitly == 1) ?  ' />&nbsp;' : ' disabled="disabled" />&nbsp;';
