...
*/
	...
	if($eID > 0){
		...
		$hc_Side[] = array(CalAdminRoot . '/index.php?com=eventedit&eID=' . cIn($eID),'iconRecycle.png',$hc_lang_event['LinkEdit'],0);
	...
	<?php makeTinyMCE('eventDescription', '525px', 'advanced', $eventDesc);?>
		...
		<div class="frmOpt">
			...
			<table cellpadding="1" cellspacing="0" border="0">
				<tr>
					<td><input onblur="buildTweet();" name="startTimeHour" id="startTimeHour" type="text" value="<?php echo $startTimeHour;?>" size="2" maxlength="2" /></td>
					...
					<td><input onblur="buildTweet();" name="startTimeMins" id="startTimeMins" type="text" value="<?php echo $startTimeMins;?>" size="2" maxlength="2" /></td>
		...
		<div class="frmOpt">
			...
			<table cellpadding="1" cellspacing="0" border="0">
				<tr>
					<td><input name="endTimeHour" id="endTimeHour" type="text" value="<?php echo $endTimeHour;?>" size="2" maxlength="2" /></td>
					...
					<td><input name="endTimeMins" id="endTimeMins" type="text" value="<?php echo $endTimeMins;?>" size="2" maxlength="2" /></td>
