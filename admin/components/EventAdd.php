 ...
 */
	...
	$eventTitle = $tbd = $eventDesc = $locName = $locAddress = $locAddress2 = $locCity = $locZip = $locCountry = $cost = $contactName = $contactEmail = $contactPhone = $contactURL = $AllDay = '';
	$state = $hc_cfg[21];
	...
	<fieldset>
		<legend>'.$hc_lang_event['RecurInfo'].'</legend>
		<label for="recurCheck">'.$hc_lang_event['Recur'].'</label>
