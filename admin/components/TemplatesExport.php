...
<?php
		echo '<br /><a href="' . CalAdminRoot . '/index.php?com=templateedit" class="icon"><img src="' . CalAdminRoot . '/images/icons/iconAdd.png" width="16" height="16" alt="" border="0" style="vertical-align:middle;" />&nbsp;' . $hc_lang_tools['AddT'] . '</a><br />';
