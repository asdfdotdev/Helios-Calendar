...
<?		}//end if
		...
		?>
		<br />
		<?	$result = doQuery("SELECT count(*) FROM " . HC_TblPrefix . "events where AlertSent = 0 AND StartDate Between '" . $startDateF . "' AND '" . $endDateF . "'");
		...
		<div style="width:400px;">
		<form name="frmNewsletter" id="frmNewsletter" method="post" action="<?echo CalAdminRoot . "/" . HC_NewsletterAction;?>">
		...
		<input name="template" id="template" type="hidden" value="<?echo $endDateF;?>" />
		<br />
	<fieldset>
