...
<?php 	}//end if
	...
	<fieldset>
		...
		<br />
<?php 	if($sendOk > 0){
			echo '<input type="submit" name="submit" id="submit" value="' . $hc_lang_news['SendNow'] . '" class="button" />&nbsp;&nbsp;';
		}//end if	?>
