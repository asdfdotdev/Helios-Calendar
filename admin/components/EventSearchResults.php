...
<?php 	}//end if	?>
	...
	<br />
<?php 	$startDate = dateToMySQL($_POST['startDate'], "/", $hc_popDateFormat);
		...
		<?php	echo cOut($row[1]);?>
			...
			<?php 	if($sID == 1){	?>
				<div class="<?php if($cnt % 2 == 0){echo "eventListTools";}else{echo "eventListToolsHL";}?>">
					...
					<a href="<?php echo CalAdminRoot;?>/index.php?com=eventedit&amp;eID=<?php echo $row[0];?>" class="main" target="_blank"><img src="<?php echo CalAdminRoot;?>/images/icons/iconNewWindow.gif" width="15" height="15" alt="" border="0" align="middle" /></a>
				</div>
			<?php 	}//end if	?>
