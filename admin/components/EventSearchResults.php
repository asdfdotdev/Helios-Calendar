...
*/
	...
	<?php 	}//end if	?>
		...
		<div class="catCtrl">
			[ <a class="catLink" href="javascript:;" onclick="checkAllArray('eventSearchResult', 'eventID[]');"><?php echo $hc_lang_search['SelectAll'];?></a>
			&nbsp;|&nbsp; <a class="catLink" href="javascript:;" onclick="uncheckAllArray('eventSearchResult', 'eventID[]');"><?php echo $hc_lang_search['DeselectAll'];?></a> ]
		</div>
<?php 	$cnt = 0;
		$curDate = "";
		while($row = mysql_fetch_row($result)){
			...
			if($sID == 1){
				...
				echo '<a href="' . CalAdminRoot . '/index.php?com=eventadd&amp;eID=' . $row[0] . '" class="main"><img src="' . CalAdminRoot . '/images/icons/iconRecycle.png" width="15" height="15" alt="" border="0" style="vertical-align:middle;" /></a>';
			}//end if
			echo '&nbsp;</div>';
