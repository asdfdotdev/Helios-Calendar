...
*/
	...
	if($sID == 0){
		appInstructions(1, "Event Edit Search Results", "Select an event from the list below to edit. To delete an event click the checkbox to the right of the event listing than click the 'Delete Marked' button below.<br><br><table cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td><img src=\"" . CalAdminRoot . "/images/iconEdit.gif\" width=\"15\" height=\"15\" alt=\"\" border=\"0\"></td><td class=\"eventMain\">&nbsp;=&nbsp;Edit Event</td></tr><tr><td><img src=\"" . CalAdminRoot . "/images/spacer.gif\" width=\"1\" height=\"4\" alt=\"\" border=\"0\"></td></tr><tr><td><img src=\"" . CalAdminRoot . "/images/iconNewWindow.gif\" width=\"15\" height=\"15\" alt=\"\" border=\"0\"></td><td class=\"eventMain\">&nbsp;=&nbsp;Edit Event In New Window</td></tr></table>");
	} else {
		appInstructions(1, "Event Report Search Results", "Select events from the list below by clicking the checkbox beside the listing. Once you have made your selection(s) click the 'Generate Report' button below.");
	}//end if
?>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<?php
		...
		$query = "	SELECT " . HC_TblPrefix . "events.*, " . HC_TblPrefix . "eventcategories.CategoryID as Category
				...
				if(isset($catIDWhere)){
					$query = $query . " AND (" . HC_TblPrefix . "eventcategories.CategoryID In(" . $catIDWhere . "))";
				}//end if
			...
			?>
					<tr>
						...
						<td class="eventMain" <?if($css % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?>>
							<a href="<?echo CalAdminRoot;?>/index.php?com=eventedit&eID=<?echo $row[0];?>" class="main"><?echo $row[1];?></a>
						</td>
					<?php
						if($sID == 0){
					?>
	...
	<tr>
		<td class="eventMain">
			...
			<a href="<?echo CalAdminRoot;?>/index.php?com=eventsearch" class="main">Please click here to search again.</a>
			<br><br>
		</td>
	</tr>
	<?php
