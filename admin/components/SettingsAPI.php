...
*/
	...
	$result = doQuery("SELECT SettingValue FROM " . HC_TblPrefix . "settings WHERE PkID IN (5,6,26,27,36,37,38,39,41,42,43,45,46,47,52,57,58,59,60,61,62) ORDER BY PkID");
	...
	$twtrUser = cOut(mysql_result($result,12,0));
	$twtrPass = cOut(mysql_result($result,13,0));
