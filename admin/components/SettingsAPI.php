...
?>
	...
	<fieldset>
		...
		<div class="frmOpt">
			...
			<div class="hc_align"><?php echo $hc_lang_settings['Latitude'];?>&nbsp;</div><input name="lmapLat" id="lmapLat" type="text" value="<?php echo $lmapLat;?>" size="10" maxlength="25" <?php if($locBrowse == 0){echo "disabled=\"disabled\"";}?> /><div class="hc_align">&nbsp;&nbsp;<?php echo $hc_lang_settings['Longitude'];?>&nbsp;</div><input name="lmapLon" id="lmapLon" type="text" value="<?php echo $lmapLon;?>" size="10" maxlength="25" <?php if($locBrowse == 0){echo "disabled=\"disabled\"";}?> />
		</div>
		<div class="frmOpt">
	...
	<fieldset>
		...
		<div class="frmOpt">
			...
			<span class="hc_align" style="line-height:18px;width:85px;"><a href="http://www.eventbrite.com/org/<?php echo $eventbriteOrgID;?>" class="eventMain" target="_blank"><?php echo $eventbriteOrgID;?></a>&nbsp;</span>
	...
	<fieldset>
		...
		if($twtrAToken == '' || $twtrASecret == ''){
			$_SESSION['RequestToken'] = $_SESSION['RequestSecret'] = '';
			...
			if($_SESSION['RequestToken'] != '' && $_SESSION['RequestSecret'] != ''){
				...
				echo '<a href="https://twitter.com/oauth/authorize?oauth_token=' . $_SESSION['RequestToken'] . '" target="_blank"><img src="' . CalAdminRoot . '/images/logos/twitter_sign_in.png" width="151" height="24" border="0" /></a>';
			...
			echo '<a href="http://twitter.com/' . $twtrUsername . '" class="twitter" target="_blank"><img src="' . CalAdminRoot . '/images/logos/twitter_mini.png" width="16" height="16" border="0" alt="" style="vertical-align:middle;" /> ' . $twtrUsername . '</a>';
			echo '</div></div>';
