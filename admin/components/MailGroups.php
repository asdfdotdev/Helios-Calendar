 ...
 */
	...
	<ul class="data">
		...
		<li class="row'.$hl.'">
			...
			<div class="tools" style="width:10%;">
				<a href="'.AdminRoot.'/?com=subgrps&amp;gID='.$row[0].'"><img src="'.AdminRoot.'/img/icons/edit.png" width="16" height="16" alt="" /></a>
	...
	function doDelete(dID){
		if(confirm("'.$hc_lang_news['Valid42'].'\\n\\n          '.$hc_lang_news['Valid43'].'\\n          '.$hc_lang_news['Valid44'].'"))
			document.location.href = "'.AdminRoot.'/components/MailGroupsAction.php?dID=" + dID;
	}
	//-->
	</script>';
