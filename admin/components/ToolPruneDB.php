...
*/
	appInstructions(0, "Database_Tools", "Prune Helios Database", "Use the button below to prune your Helios database by permanently removing all declined and deleted events.");	
