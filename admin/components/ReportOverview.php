...
*/
	...
	include('../../events/includes/headerAdmin.php');	?>
		<title><?php echo CalName;?> Overview Report</title>
	</head>
...
<?php
	...
	<div style="float:left;width:350px;">
		<span style="font-family:verdana;font-size:15px;font-weight:bold;"><?php echo CalName;?> Overview Report</span><br />
		<b>Created at:</b> <?php echo date("Y-m-d g:i:s A");?><br />
		<b>Calendar:</b> <?php echo CalRoot;?>/<br />
		<b>Generated by:</b> Helios Calendar <?php echo HC_Version;?>
	</div>
...
<?php
		...
		<div align="right"><img src="<?php echo CalAdminRoot;?>/images/icons/iconPrint.gif" width="15" height="15" alt="" border="0" align="absmiddle" /> <a href="<?php echo CalAdminRoot;?>/components/ReportOverview.php?print=1" class="main" target="_blank">Printer Friendly</a></div>
<?php
	}//end if	?>
	...
	<?php 	$result = doQuery("SELECT COUNT(*) FROM " . HC_TblPrefix . "events WHERE IsActive = 1 AND IsApproved = 1 AND StartDate >= NOW()");
			if(hasRows($result)){
	...
	<?php 	$result = doQuery("SELECT COUNT(*) FROM " . HC_TblPrefix . "events WHERE IsActive = 0");
		...
		<div class="overviewCount">
	<?php 	$result = doQuery("SELECT COUNT(*) FROM " . HC_TblPrefix . "events WHERE IsActive = 1 AND IsApproved = 1 AND IsBillboard = 1 AND StartDate >= NOW()");
			if(hasRows($result)){
				echo mysql_result($result,0,0);
			} else {
				echo "N/A";
...
<?php 	$result = doQuery("	SELECT SUM(Views) as Views,
		...
		<div class="overviewAverage"><?php if($activeEvents > 0){echo number_format($aViews / $activeEvents, 2, '.', ',');}else{echo "0";}?></div>
		<div class="overviewTotal"><?php if($aViews != ''){echo $aViews;}else{echo "0";}?></div>
		<div class="overviewDetailsHL">Mobile Views</div>
		<div class="overviewAverageHL"><?php if($activeEvents > 0){echo number_format($aMViews / $activeEvents, 2, '.', ',');}else{echo "0";}?></div>
		<div class="overviewTotalHL"><?php if($aMViews != ''){echo $aMViews;}else{echo "0";}?></div>
		<div class="overviewDetails">Driving Directions</div>
		<div class="overviewAverage"><?php if($activeEvents > 0){echo number_format($aDirections / $activeEvents, 2, '.', ',');}else{echo "0";}?></div>
		<div class="overviewTotal"><?php if($aDirections != ''){echo $aDirections;}else{echo "0";}?></div>
		<div class="overviewDetailsHL">Downloads</div>
		<div class="overviewAverageHL"><?php if($activeEvents > 0){echo number_format($aDownloads / $activeEvents, 2, '.', ',');}else{echo "0";}?></div>
		<div class="overviewTotalHL"><?php if($aDownloads != ''){echo $aDownloads;}else{echo "0";}?></div>
		<div class="overviewDetails">Email to Friend</div>
		<div class="overviewAverage"><?php if($activeEvents > 0){echo number_format($aEmail / $activeEvents, 2, '.', ',');}else{echo "0";}?></div>
		<div class="overviewTotal"><?php if($aEmail != ''){echo $aEmail;}else{echo "0";}?></div>
		<div class="overviewDetailsHL">URL Clicks</div>
		<div class="overviewAverageHL"><?php if($activeEvents > 0){echo number_format($aURL / $activeEvents, 2, '.', ',');}else{echo "0";}?></div>
		<div class="overviewTotalHL"><?php if($aURL != ''){echo $aURL;}else{echo "0";}?></div>
<?php 	$result = doQuery("	SELECT SUM(Views) as Views,
								SUM(Directions) as Directions,
								SUM(Downloads) as Downloads,
								SUM(EmailToFriend) as EmailToFriend,
		...
		<div class="overviewTotal" style="padding-top:10px;line-height:11px;vertical-align:bottom;"><b>&nbsp;<br />Total</b></div>
		<div class="overviewDetails">Views</div>
		<div class="overviewAverage"><?php if($pastEvents > 0){echo number_format($pViews / $pastEvents, 2, '.', ',');}else{echo "0";}?></div>
		<div class="overviewTotal"><?php if($pViews != ''){echo $pViews;}else{echo "0";}?></div>
		<div class="overviewDetailsHL">Mobile Views</div>
		<div class="overviewAverageHL"><?php if($pastEvents > 0){echo number_format($pMViews / $pastEvents, 2, '.', ',');}else{echo "0";}?></div>
		<div class="overviewTotalHL"><?php if($pMViews != ''){echo $pMViews;}else{echo "0";}?></div>
		<div class="overviewDetails">Driving Directions</div>
		<div class="overviewAverage"><?php if($pastEvents > 0){echo number_format($pDirections / $pastEvents, 2, '.', ',');}else{echo "0";}?></div>
		<div class="overviewTotal"><?php if($pDirections != ''){echo $pDirections;}else{echo "0";}?></div>
		<div class="overviewDetailsHL">Downloads</div>
		<div class="overviewAverageHL"><?php if($pastEvents > 0){echo number_format($pDownloads / $pastEvents, 2, '.', ',');}else{echo "0";}?></div>
		<div class="overviewTotalHL"><?php if($pDownloads != ''){echo $pDownloads;}else{echo "0";}?></div>
		<div class="overviewDetails">Email to Friend</div>
		<div class="overviewAverage"><?php if($pastEvents > 0){echo number_format($pEmail / $pastEvents, 2, '.', ',');}else{echo "0";}?></div>
		<div class="overviewTotal"><?php if($pEmail != ''){echo $pEmail;}else{echo "0";}?></div>
		<div class="overviewDetailsHL">URL Clicks</div>
		<div class="overviewAverageHL"><?php if($pastEvents > 0){echo number_format($pURL / $pastEvents, 2, '.', ',');}else{echo "0";}?></div>
		<div class="overviewTotalHL"><?php if($pURL != ''){echo $pURL;}else{echo "0";}?></div>
<?php 	$result = doQuery("	SELECT SUM(Views) as Views,
								SUM(Directions) as Directions,
								SUM(Downloads) as Downloads,
								SUM(EmailToFriend) as EmailToFriend,
		...
		<div class="overviewTotal" style="padding-top:10px;line-height:11px;vertical-align:bottom;"><b>&nbsp;<br />Total</b></div>
		<div class="overviewDetails">Views</div>
		<div class="overviewAverage"><?php echo number_format($tViews / $totalEvents, 2, '.', ',');?></div>
		<div class="overviewTotal"><?php echo $tViews;?></div>
		<div class="overviewDetailsHL">Mobile Views</div>
		<div class="overviewAverageHL"><?php echo number_format($tMViews / $totalEvents, 2, '.', ',');?></div>
		<div class="overviewTotalHL"><?php echo $tMViews;?></div>
		<div class="overviewDetails">Driving Directions</div>
		<div class="overviewAverage"><?php echo number_format($tDirections / $totalEvents, 2, '.', ',');?></div>
		<div class="overviewTotal"><?php echo $tDirections;?></div>
		<div class="overviewDetailsHL">Downloads</div>
		<div class="overviewAverageHL"><?php echo number_format($tDownloads / $totalEvents, 2, '.', ',');?></div>
		<div class="overviewTotalHL"><?php echo $tDownloads;?></div>
		<div class="overviewDetails">Email to Friend</div>
		<div class="overviewAverage"><?php echo number_format($tEmail / $totalEvents, 2, '.', ',');?></div>
		<div class="overviewTotal"><?php echo $tEmail;?></div>
		<div class="overviewDetailsHL">URL Clicks</div>
		<div class="overviewAverageHL"><?php echo number_format($tURL / $totalEvents, 2, '.', ',');?></div>
		<div class="overviewTotalHL"><?php echo $tURL;?></div>

<?php 	if(isset($_GET['print'])){	?>
			<div style="clear:both;width:650px;padding: 10px 0px 0px 0px;">
				<span class="main"><b>Generated by Helios Calendar <?php echo HC_Version;?> -- www.HeliosCalendar.com</b></span>
...
<?php 		$cnt = 0;
			while($row = mysql_fetch_row($result)){	?>
				...
				<div class="overviewDate<?php if($cnt % 2 == 1){echo "HL";}?>"><?php echo stampToDate($row[1], "Y-m-d");?></div>
				<div class="overviewDate<?php if($cnt % 2 == 1){echo "HL";}?>"><?php echo stampToDate($row[2], "Y-m-d");?></div>
<?php 		$cnt++;
			}//end while
		} else {	?>
...
<?php 		$cnt = 0;
			while($row = mysql_fetch_row($result)){	?>
				...
				<div class="overviewDate<?php if($cnt % 2 == 1){echo "HL";}?>"><?php echo stampToDate($row[3], "Y-m-d");?></div>
<?php 		$cnt++;
			}//end while
		} else {	?>
			<div style="clear:both;padding: 20px 0px 0px 0px;">There are no users currently available for the <b>Newest Users</b> report.</div>
<?php 	}//end if
