...
<?php
		...
		<div align="right"><img src="<?php echo CalAdminRoot;?>/images/icons/iconPrint.gif" width="15" height="15" alt="" border="0" align="middle" /> <a href="<?php echo CalAdminRoot;?>/components/ReportOverview.php?print=1" class="main" target="_blank">Printer Friendly</a></div>
<?php
	}//end if	?>
