		...
		<td>
			...
			<?php
				...
				<?
					...
					?>
						<tr>
							<td <?if($cnt % 2 == 0){echo "bgcolor=\"#EEEEEE\"";}?>><?echo $row[1];?></td>
							<td <?if($cnt % 2 == 0){echo "bgcolor=\"#EEEEEE\"";}?>><?echo $row[2];?></td>
							<td <?if($cnt % 2 == 0){echo "bgcolor=\"#EEEEEE\"";}?>><?echo $row[3];?></td>
							<td align="center" <?if($cnt % 2 == 0){echo "bgcolor=\"#EEEEEE\"";}?>><input type="checkbox" name="dID[]" id="dID_<?echo $row[0];?>" value="<?echo $row[0];?>"></td>
						</tr>
					<?
						$cnt++;
					}//end while
