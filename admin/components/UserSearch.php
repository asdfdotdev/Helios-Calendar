...
<?php
	...
	appInstructions(0, "Searching_Recipients", "User Edit", "Use the form below to search for the user you wish to edit.<br /><br />If you wish to search by only part of a name or email address, only type as much of the search criteria as you wish to match.");	?>
	<div style="width:60%;">
