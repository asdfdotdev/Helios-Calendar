		...
		foreach ($dates as $val){
			...
			$query = "	INSERT INTO " . HC_TblPrefix . "events(Title, LocationName, LocationAddress, LocationAddress2, 
						...
						VALUES('" . $eventTitle . "', '" . $locName . "', '" . $locAddress . "', '" . $locAddress2 . "',
								...
								1, '" . $eventStatus . "', '" . $eventBillboard . "', '" . $eventID . "',
								'" . $allowRegistration . "', '" . $maxRegistration . "', " . $publishDate . ");";
			...
			if(isset($_POST['catID'])){
				$catID = $_POST['catID'];
					foreach ($catID as $val){
						doQuery("INSERT INTO " . HC_TblPrefix . "eventcategories(EventID, CategoryID) VALUES('" . $newPkID . "', '" . $val . "')");
					}//end while
