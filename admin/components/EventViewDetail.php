...
*/
	...
	$result = doQuery("SELECT * FROM " . HC_TblPrefix . "events WHERE PkID IN(" . $eID . ") ORDER BY StartDate");
	...
	if(hasRows($result)){
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				<td width="20"><img src="<?echo CalAdminRoot;?>/images/iconPrint.gif" width="15" height="15" alt="" border="0"></td>
		...
		<img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="7" alt="" border="0">
		<?
		} else {
		?>
			<html>
			...
			<body>
			<img src="<?echo CalAdminRoot;?>/images/logo.gif" width="240" height="45" alt="" border="0">
		<?
		}//end if
			...
			$maxViews = mysql_result($resultX,0,0);
			$maxMobileViews = mysql_result($resultX,0,1);
			$maxDirections = mysql_result($resultX,0,2);
			$maxDownloads = mysql_result($resultX,0,3);
			$maxEmail = mysql_result($resultX,0,4);
			$maxURL = mysql_result($resultX,0,5);
		...
		?>
				<img class="breakhere" src="<?echo CalAdminRoot;?>/images/logo.gif" width="240" height="45" alt="" border="0">
		<?
			}//end if
		?>
							...
							<tr>
								<td colspan="2" class="eventMain">
									...
									<table cellpadding="0" cellspacing="0" border="0" width="100%">
										...
										<tr>
											<td class="eventMain" width="125">&nbsp;Views (<?echo $row[28];?>):</td>
											<td><img src="<?echo CalAdminRoot;?>/images/meterEnds.gif" width="1" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterGreen.gif" width="<?echo $meterViews;?>" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterLGray.gif" width="<?echo $meterViewsFill?>" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterEnds.gif" width="1" height="10" alt="" border="0"></td>
											<td class="eventMain" align="right"><?echo $maxViews;?></td>
											<td class="eventMain" align="right"><?echo number_format($aveViews, 2, '.', '');?></td>
										</tr>
										<tr><td colspan="4"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="4" alt="" border="0"></td></tr>
										<tr>
											<td class="eventMain" width="125">&nbsp;Mobile Views (<?echo $row[34];?>):</td>
											<td><img src="<?echo CalAdminRoot;?>/images/meterEnds.gif" width="1" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterBlue.gif" width="<?echo $meterMobileViews;?>" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterLGray.gif" width="<?echo $meterMobileViewsFill?>" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterEnds.gif" width="1" height="10" alt="" border="0"></td>
										...
										<tr><td colspan="4"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="4" alt="" border="0"></td></tr>
										<tr>
											<td class="eventMain">&nbsp;Directions (<?echo $row[30];?>):</td>
											<td><img src="<?echo CalAdminRoot;?>/images/meterEnds.gif" width="1" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterYellow.gif" width="<?echo $meterDirections;?>" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterLGray.gif" width="<?echo $meterDirectionsFill?>" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterEnds.gif" width="1" height="10" alt="" border="0"></td>
											<td class="eventMain" align="right"><?echo $maxDirections;?></td>
											<td class="eventMain" align="right"><?echo number_format($aveDirections, 2, '.', '');?></td>
										</tr>
										<tr><td colspan="4"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="4" alt="" border="0"></td></tr>
										<tr>
											<td class="eventMain">&nbsp;Downloads (<?echo $row[31];?>):</td>
											<td><img src="<?echo CalAdminRoot;?>/images/meterEnds.gif" width="1" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterPurple.gif" width="<?echo $meterDownloads;?>" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterLGray.gif" width="<?echo $meterDownloadsFill?>" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterEnds.gif" width="1" height="10" alt="" border="0"></td>
											<td class="eventMain" align="right"><?echo $maxDownloads;?></td>
											<td class="eventMain" align="right"><?echo number_format($aveDownloads, 2, '.', '');?></td>
										</tr>
										<tr><td colspan="4"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="4" alt="" border="0"></td></tr>
										<tr>
											<td class="eventMain">&nbsp;Email to Friend (<?echo $row[32];?>):</td>
											<td><img src="<?echo CalAdminRoot;?>/images/meterEnds.gif" width="1" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterPeach.gif" width="<?echo $meterEmail;?>" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterLGray.gif" width="<?echo $meterEmailFill?>" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterEnds.gif" width="1" height="10" alt="" border="0"></td>
											<td class="eventMain" align="right"><?echo $maxEmail;?></td>
											<td class="eventMain" align="right"><?echo number_format($aveEmail, 2, '.', '');?></td>
										</tr>
										<tr><td colspan="4"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="4" alt="" border="0"></td></tr>
										<tr>
											<td class="eventMain">&nbsp;URL Clicks (<?echo $row[33];?>):</td>
											<td><img src="<?echo CalAdminRoot;?>/images/meterEnds.gif" width="1" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterDGray.gif" width="<?echo $meterURL;?>" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterLGray.gif" width="<?echo $meterURLFill?>" height="10" alt="" border="0"><img src="<?echo CalAdminRoot;?>/images/meterEnds.gif" width="1" height="10" alt="" border="0"></td>
