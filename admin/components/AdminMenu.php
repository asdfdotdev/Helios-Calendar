 ...
 */
	...
	if(hasRows($result)){
		...
		if($adminNewsletter == 1 || $adminUserEdit == 1){
			...
			echo '<a href="#" class="MenuLink"><span>' . $hc_lang_menu['Newsletter'] . '</span></a>';
			echo '<ul id="subMenu6" class="subMenu">';
			if($adminNewsletter == 1){
				echo '<li><a href="' . CalAdminRoot . '/index.php?com=newsdraft" class="subMenuLink">' . $hc_lang_menu['DraftCreate'] . '</a></li>';
				echo '<li><a href="' . CalAdminRoot . '/index.php?com=newscreate" class="subMenuLink">' . $hc_lang_menu['NewsCreate'] . '</a></li>';
				echo '<li><a href="' . CalAdminRoot . '/index.php?com=newsqueue" class="subMenuLink">' . $hc_lang_menu['NewsQueue'] . '</a></li>';
				echo '<li><a href="#" class="subMenuHeader">' . $hc_lang_menu['ManageN'] . '</a></li>';
				echo '<li><a href="' . CalAdminRoot . '/index.php?com=mailtmplt" class="subMenuLink">' . $hc_lang_menu['Template'] . '</a></li>';
				echo '<li><a href="' . CalAdminRoot . '/index.php?com=subgrps" class="subMenuLink">' . $hc_lang_menu['Groups'] . '</a></li>';
			}//end if
			if($adminUserEdit == 1){
				echo '<li><a href="#" class="subMenuHeader">' . $hc_lang_menu['Subscribers'] . '</a></li>';
				echo '<li><a href="' . CalAdminRoot . '/index.php?com=subedit" class="subMenuLink">' . $hc_lang_menu['AddS'] . '</a></li>';
				echo '<li><a href="' . CalAdminRoot . '/index.php?com=submngt" class="subMenuLink">' . $hc_lang_menu['EditS'] . '</a></li>';
			}//end if
		echo '</ul></li>';
		}//end if
		...
		if($adminReports == 1){
			...
			echo '<li><a href="#" class="subMenuHeader">' . $hc_lang_menu['Maintenance'] . '</a></li>';
			echo '<li><a href="' . CalAdminRoot . '/index.php?com=reportdup" class="subMenuLink">' . $hc_lang_menu['DuplicateEvents'] . '</a></li>';
			echo '</ul></li>';
		}//end if
			
		echo '<li onmouseover="subMenu(true,9)" onmouseout="subMenu(false,9);">';
		echo '<a href="#" class="MenuLink"><span>' . $hc_lang_menu['Help'] . '</span></a>';
		echo '<ul id="subMenu9" class="subMenu">';
