 ...
 */
	...
	if(hasRows($result)){
		...
		$adminEventCategory = hc_mysql_result($result,0,"EventCategory");
		$adminUserEdit = hc_mysql_result($result,0,"UserEdit");
		$adminAdminEdit = hc_mysql_result($result,0,"AdminEdit");
		$adminNewsletter = hc_mysql_result($result,0,"Newsletter");
		$adminSettings = hc_mysql_result($result,0,"Settings");
		$adminTools = hc_mysql_result($result,0,"Tools");
		$adminReports = hc_mysql_result($result,0,"Reports");
		$adminLocations = hc_mysql_result($result,0,"Locations");
		$adminPages = hc_mysql_result($result,0,"Pages");
