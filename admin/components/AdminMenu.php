...
*/
	...
	if(hasRows($result)){
		...
		if($adminTools == 1 || $adminNewsletter == 1){
			...
			if($adminTools == 1){
				...
				echo '<li><a href="#" class="subMenuHeader">' . $hc_lang_menu['Data'] . '</a></li>';
			...
			if($adminNewsletter == 1){
				...
				echo '<li><a href="' . CalAdminRoot . '/index.php?com=newsletteredit" class="subMenuLink">' . $hc_lang_menu['EditT'] . '</a></li>';
			}//end if
			echo '</ul></li>';
		}//end if
		...
		echo '<li><a href="' . CalAdminRoot . '/index.php?com=about" class="subMenuLink">' . $hc_lang_menu['About'] . ' Helios ' . $hc_cfg49 . '</a></li>';
	...
	function popAbout(){var windowW = 460;var windowH = 485;var windowX = (screen.width / 2) - (windowW / 2);var windowY = (screen.height / 2) - (windowH / 2);aboutWin = window.open('<?php echo CalAdminRoot;?>/components/About.php', 'about', 'width='+windowW+', height='+windowH+', scrollbars=yes');aboutWin.resizeTo(windowW, windowH);aboutWin.moveTo(windowX, windowY);aboutWin.focus();}
	//-->
	</script>