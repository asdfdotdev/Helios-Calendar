			...
			<?if($adminEventEdit == 1 OR $adminEventPending == 1 OR $adminEventCategory == 1){?>
				...
				<a href="javascript:;">Events</a>
					<ul id="subMenu1" class="subMenu">
						<?if($adminEventEdit == 1){?>
							<li><a href="<?echo CalAdminRoot;?>/index.php?com=eventadd">Add&nbsp;an&nbsp;Event</a></li>
							<li><a href="<?echo CalAdminRoot;?>/index.php?com=eventsearch">Edit&nbsp;an&nbsp;Event</a></li>
						<?}//end if?>
						
						<?if($adminEventPending == 1){?>
						<li><a href="<?echo CalAdminRoot;?>/index.php?com=eventpending">Review&nbsp;Pending&nbsp;Events</a></li>
						<?}//end if?>
			...
			<?if($adminUserEdit == 1 OR $adminNewsletter == 1){?>
				...
				<a href="javascript:;">Newsletter</a>
					<ul id="subMenu2" class="subMenu">
						<?if($adminUserEdit == 1){?>
						<li><a href="<?echo CalAdminRoot;?>/index.php?com=useredit">Add&nbsp;Newsletter&nbsp;Recipient</a></li>
						<li><a href="<?echo CalAdminRoot;?>/index.php?com=userbrowse">Edit&nbsp;Newsletter&nbsp;Recipient</a></li>
						<li><a href="<?echo CalAdminRoot;?>/index.php?com=usersearch">Search&nbsp;Newsletter&nbsp;Recipients</a></li>
						<?}//end if?>
						
						<?if($adminNewsletter == 1){?>
						<li><a href="<?echo CalAdminRoot;?>/index.php?com=newsletter">Send&nbsp;Event&nbsp;Newsletter</a></li>
						<li><a href="<?echo CalAdminRoot;?>/index.php?com=newsletteredit">Edit&nbsp;Newsletter&nbsp;Templates</a></li>
						<?}//end if?>
					</ul>
				</li>
			<?}//end if?>
			...
			<?if($adminSettings == 1){?>
				...
				<a href="javascript:;">Settings</a>
					<ul id="subMenu4" class="subMenu">
						<li><a href="<?echo CalAdminRoot;?>/index.php?com=generalset">General&nbsp;Settings</a></li>
						<li><a href="<?echo CalAdminRoot;?>/index.php?com=billboard">Billboard</a></li>
			...
			<?if($adminReports == 1){?>
				...
				<a href="javascript:;">Reports</a>
					<ul id="subMenu5" class="subMenu">
						<li><a href="<?echo CalAdminRoot;?>/index.php?com=eventsearch&sID=1">Event&nbsp;Activity&nbsp;Report</a></li>
