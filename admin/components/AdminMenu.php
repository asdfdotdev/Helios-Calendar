...
?>
		<ul class="menu">
			...
			<li onmouseover="subMenu( true, 0 )" onmouseout="subMenu( false, 0 )">
				<a href="<?echo CalAdminRoot;?>/index.php?com=member">Members</a>
				<ul id="subMenu0" class="subMenu">
					<li><a href="<?echo CalAdminRoot;?>/index.php?com=member">Browse&nbsp;Members</a></li>
					<li><a href="<?echo CalAdminRoot;?>/index.php?com=memberadd">Add&nbsp;Member</a></li>
				</ul>
			</li>
