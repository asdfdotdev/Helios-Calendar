	...
	<ul>
		...
		<li><a href="#">' . $hc_lang_menu['Settings'] . '</a>
			<ul>
				...
				<li><a href="' . AdminRoot . '/index.php?com=apiset">' . $hc_lang_menu['API'] . '</a></li>
		...
		<li>
			...
			<ul id="subMenu9" class="subMenu">
				...
				<li><a href="#" class="sub_header">' . $hc_lang_menu['OnlineResources'] . '</a></li>
				<li><a href="http://www.refreshmy.com/documentation/?title=Helios" target="_blank">' . $hc_lang_menu['Documentation'] . '</a></li>
				<li><a href="http://www.refreshmy.com/forum/" target="_blank">' . $hc_lang_menu['Forum'] . '</a></li>
			</ul>
		</li>
		<li class="nosub"><a href="' . AdminRoot . '/' . HC_LogOut . '">' . $hc_lang_menu['Logout'] . '</a></li>
	</ul>';
	} else {
		echo '
	<ul>
		<li><a href="' . AdminRoot . '/' . HC_LogOut . '">Permissions Not Found</a></li>
	</ul>';
	}
?>