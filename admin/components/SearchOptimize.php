 ...
 */
	...
	$result = doQuery("SELECT SettingValue FROM " . HC_TblPrefix . "settings WHERE PkID IN (7,85,87) ORDER BY PkID");
	...
	<fieldset style="border:0;">
		...
		<input name="sitemap" id="sitemap" type="number" min="1" max="10" size="5" maxlength="4" required="required" value="'.$sitemap.'" />
		<span class="output">
