...
<?	if (isset($_GET['msg'])){
	...
	<form name="frm" id="frm" method="post" action="<?echo CalAdminRoot . "/components/SearchOptimizeAction.php";?>" onsubmit="return chkFrm();">
	<br />
	<fieldset>
		...
		<div class="frmOpt">
			...
			<select name="indexing" id="indexing">
				<option <?if($allowindex == 1){echo "SELECTED";}//end if?> value="1">Yes, Allow Indexing</option>
				<option <?if($allowindex == 0){echo "SELECTED";}//end if?> value="0">No, Prevent Indexing</option>
			</select>
		...
		<div class="frmOpt">
			...
			<input name="keywords" id="keywords" size="60" maxlength="250" type="text" value="<?echo $keywords;?>" />
		</div>
		<div class="frmOpt">
			<label for="description">Description:</label>
			<input name="description" id="description" size="60" maxlength="250" type="text" value="<?echo $description;?>" />
		</div>
	</fieldset>
	<br />
