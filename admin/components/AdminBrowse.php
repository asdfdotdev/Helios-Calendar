					...
					<?php
						...
						?>
							...
							<tr>
								...
								<td <?if($cnt % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?>><a href="javascript:;" onClick="doDelete('<?echo $row[0];?>');return false;" class="main" title="Delete Admin"><img src="<?echo CalAdminRoot;?>/images/iconDelete.gif" width="15" height="15"  title="Delete Admin" alt="" border="0"></a>&nbsp;</td>
							</tr>
							<tr><td colspan="4" <?if($cnt % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?>><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="1" alt="" border="0"></td></tr>
						<?
							$cnt++;
