	...
	if(!isset($_GET['dID'])){
		...
		if(hasRows($result)){
			...
			if(hasRows($result)){
				...
				if($_SESSION['AdminPkID'] != $uID){
					doQuery("INSERT INTO " . HC_TblPrefix . "adminpermissions(EventEdit, EventPending, EventCategory, UserEdit, AdminEdit, Newsletter, Settings, Tools, Reports, AdminID, IsActive)
