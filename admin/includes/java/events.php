...
*/?>
	...
	function buildTweet(){
		var locTweet = (document.getElementById('locPreset').value > 0) ? document.getElementById('locPresetName').value : document.getElementById('locName').value ;
		var timeTweet = (document.getElementById('startTimeAMPM') != null) ?
		...
		if(document.getElementById('recurCheck'))
			dateRecur = (document.getElementById('recurCheck').checked) ? ' - ' + document.getElementById('recurEndDate').value : ''

		document.getElementById('tweetThis').value = tweetPrefix + ' ' +
		document.getElementById('eventTitle').value + ' @ ' + locTweet + ' - ' + timeTweet + ' <?php echo $hc_lang_event['On'];?> ' +
		document.getElementById('eventDate').value + dateRecur;
	}//end buildTweet
