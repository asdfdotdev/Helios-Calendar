	...
	<tr>
		...
		<td width="780" valign="top" class="topMenu" height="21">
			...
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td colspan="2" width="780" class="main"><?include(HC_AdminMenu);?></td>
				</tr>
				<tr>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				<tr>
					<td valign="middle" align="center" class="main">
						<br><br><br>
						<b>Admin Demo Requires Account Registration</b><br>
						<a href="../registration/" class="main">Register for a demo account here</a>.
						<br><br><br>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="180" height="200" align="center" class="main" style="background-color: #EFEFEF; border: solid #BDBDBD 1px;">
									...
									<div align="left" style="padding: 3px;">
										...
										If you need assistant contact the <a href="mailto:<?echo CalAdminEmail;?>?subject=<?echo CalName;?> Administration Question" class="main">site administrator</a>.
									</div>
								</td>
