 ...
 */
	...
	function appInstructions($noSwitch, $codex, $title, $message){
		...
		<div class="instruction'.$style.'">
			<h5>' . $title . '</h5>
			<div class="links">
				'.(($codex != '') ? '<a href="http://www.refreshmy.com/documentation/index.php?title=Helios:_'.$codex.'" target="_blank"><img src="'.AdminRoot.'/img/icons/help.png" width="16" height="16" alt="" /></a>' : '').'
	...
	function location_select(){
		...
		if($hc_cfg[70] == 1){
			...
			<input type="text" name="locSearchText" id="locSearchText" onkeyup="searchLocations();" size="30" maxlength="100" placeholder="'.$hc_lang_submit['PlaceLocSearch'].'" value="" x-webkit-speech onwebkitspeechchange="searchLocations();" />
