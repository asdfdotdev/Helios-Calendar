	...
	function int_week_dashboard($submit = 1,$ical = 1,$rss = 1, $end_time = 1, $menu_format = '%a %m/%d'){
		...
		<div id="hc_dashboard">
			<ul id="menu">
				...
				'.(($rss == 1) ? '<li class="icon"><a href="'.CalRoot.'/rss/" title="'.$hc_lang_int['TitleRSS'].'" rel="nofollow" target="_blank"><img src="'.CalRoot.'/img/feed.png" width="16" height="16" alt="" /></a></li>':'').'
				'.(($ical == 1) ? '<li class="icon"><a href="webcal://'.substr(CalRoot, 7).'/link/ical.php" title="'.$hc_lang_int['TitleiCal'].'" rel="nofollow"><img src="'.CalRoot.'/img/icons/ical.png" width="16" height="16" alt="" /></a></li>':'').'
			</ul>';
