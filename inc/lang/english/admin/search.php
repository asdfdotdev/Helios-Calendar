...
//	Tooltips
'Tip01'				=>	'Limit search results to only multiple date events (Event Series). Search results will show only the earliest active occurance of the event series.',
