...
'EventfulNotice'	=>	'The following information about this location will be submitted:<ul><li>Name</li><li>Address</li><li>City</li><li>State(Region)</li><li>Country</li><li>Zip Code</li><li>Description</li><li>Website URL</li></ul><b>Note:</b> Before processing this location\'s submission Helios will attempt to retrieve <b>only the Venue ID</b> for this location from Eventful. If the Venue ID is retrieved the Eventful Venue will not be edited and Helios will submit your events for that Venue.',
