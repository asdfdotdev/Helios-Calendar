 ...
 */
	...
	//<!--
	tinyMCE_GZ.init({
		plugins :  "'.($admin == 1 ? 'imagemanager,':'').'spellchecker,advhr,advimage,advlink,advlist,autolink,autoresize,contextmenu'.(($admin == 1 && $fullpage == 1) ? ',fullpage':'').',fullscreen,inlinepopups,insertdatetime,layer,media,paste,preview,searchreplace,style,table,visualchars,wordcount,xhtmlxtras",
	...
	tinyMCE.init({
		...
		elements : "'.$textName.'",
		entity_encoding : "raw",
		plugins :  "'.($admin == 1 ? 'imagemanager,':'').',spellchecker,advhr,advimage,advlink,advlist,autolink,autoresize,contextmenu,emotions'.(($admin == 1 && $fullpage == 1) ? ',fullpage':'').',fullscreen,inlinepopups,layer,media,paste,preview,searchreplace,style,tabfocus,table,visualchars,wordcount,xhtmlxtras",
