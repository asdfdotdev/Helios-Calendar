 ...
 */
	...
	function gmap_locations(){
		...
		if(!file_exists(HCPATH.'/cache/lmap'.SYSDATE)){
			...
			$result = doQuery("SELECT l.PkID, l.Name, l.Address, l.Address2, l.City, l.State, l.Country, l.Zip, l.Lat, l.Lon, COUNT(e.LocID) as ECnt, MIN(e.StartDate), l.URL, l.Phone
