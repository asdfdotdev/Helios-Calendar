 ...
 */
	...
	if(!isset($_SESSION['hc_favCat']) && isset($_COOKIE[$hc_cfg[000] . '_fn']))
		$_SESSION['hc_favCat'] = cIn(strip_tags(base64_decode($_COOKIE[$hc_cfg[000] . '_fn'])));
	
	if(!isset($_SESSION['hc_favCity']) && isset($_COOKIE[$hc_cfg[000] . '_fc']))
		$_SESSION['hc_favCity'] = explode(',',cIn(strip_tags(base64_decode($_COOKIE[$hc_cfg[000] . '_fc']))));
