 ...
 */
	...
	function search_result(){
		...
		if($keyword != '')
			$sQuery .= " AND MATCH(Title,LocationName,Description) AGAINST('" . cIn($keyword,0) . "' IN BOOLEAN MODE) ";
		...
		echo '<p>'.$hc_lang_search['ResultLabel']. ' [<a href="'.CalRoot.'/index.php?com=searchresult&amp;r='.$doRecur."&amp;s=".urlencode($startDate)."&amp;e=".urlencode($endDate).'&amp;k='.urlencode(substr(cleanXMLChars($keyword,1),0,50)).$link.'">'.$hc_lang_search['ResultLink'].'</a>]';
