 ...
 */
	...
	function event_browse_nav($prev,$next,$window,$location){
		...
		<div class="nav">
			'.$loc.'
			<a href="'.CalRoot.'/index.php?m=1'.$location.'" rel="nofollow"><img src="'.CalRoot.'/img/nav/daily.png" alt="'.$hc_lang_event['ALTBrowseD'].'" title="'.$hc_lang_event['ALTBrowseD'].'" /></a>
		...
		echo '
			...
			<ul class="no_events">
				<li>'.$hc_lang_event['NoEvent1'] . '&nbsp;
					<table class="mini-cal" style="display:inline;vertical-align:middle;"><tr><td class="events" style="padding:3px;">03</td></tr></table>
				</li>
