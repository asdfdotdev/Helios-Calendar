 ...
 */
	 ...
	 * @return void
	 */
	function tool_menu($add){
		global $hc_lang_tools;
		
		echo '
	<ul class="tools">
		<li><a href="'.CalRoot.'/index.php?com=tools&amp;t=1">'.$hc_lang_tools['Tools1'].'</a>'.$hc_lang_tools['Tools1About'].'</li>
	...
	function tool_rss(){
		...
		<h3>'.$hc_lang_tools['Guidelines'].'</h3>
		<p>'.$hc_lang_tools['GuidelineText'].'</p>';
	}
	/**
	...
	function tool_syndication(){
		...
		<textarea style="width:95%;" onfocus="this.select();" wrap="off" rows="10" readonly="readonly">&lt;script src="'.CalRoot.'/js/e.php?s=0&amp;z=10&amp;t=1"&gt;
//<!--
...
<div id="map_canvas"></div></textarea>';
	...
	<h3>Opera</h3>
	<p>'.$hc_lang_tools['SearchOpera'].'</p>
	<form name="OperaSearch" id="OperaSearch" method="post" action="'.CalRoot.'/index.php?com=searchresult">
		<input title="test" type="text" name="keyword" id="keyword" value="" />
	</form>
	<h3>Google Chrome</h3>
	<p>'.$hc_lang_tools['SearchChrome'].'</p>
	'.$hc_lang_tools['SearchChromeList'].'
	<h3>'.$hc_lang_tools['SearchHelp'].'</h3>
	<p>'.$hc_lang_tools['SearchHelpLabel'].'</p>
	<ul>
		<li><a href="http://www.google.com/support/chrome/bin/search.py?query=manage+search+providers" rel="nofollow" target="_blank">Google Chrome</a></li>
		<li><a href="http://www.bing.com/search?q=internet+explorer+manage+search+providers" rel="nofollow" target="_blank">Internet Explorer</a></li>
		<li><a href="http://kb.mozillazine.org/Search_Bar" rel="nofollow" target="_blank">Mozilla Firefox</a></li>
		<li><a href="http://www.opera.com/browser/tips/?feature=customsearch" rel="nofollow" target="_blank">Opera</a></li>
	</ul>';
	}
?>