 ...
 */
	...
	<ul class="breadbox">
		...
		foreach($crumbs as $link => $text){
			echo ($link != 'NULL') ? '
		<li itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a href="'.$link.'" itemprop="url"><span itemprop="title">'.crumb_limit($text,$limit).'</span></a><span class="arrow"><span>&nbsp;</span></span></li>' : '
