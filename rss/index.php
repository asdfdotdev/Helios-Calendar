 ...
 */
	...
	if(!file_exists(HCPATH.'/cache/rss'.SYSDATE.'_' . $sID)){
		...
		$bQuery = ($sID == 3) ? " AND IsBillboard = 1 " : '';
		
		$query = "SELECT DISTINCT PkID, Title, Description, StartDate, StartTime, SeriesID, PublishDate, (Views / (DATEDIFF('".SYSDATE."', PublishDate)+1)) as Ave
